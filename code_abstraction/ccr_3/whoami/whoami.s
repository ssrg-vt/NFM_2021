...
.label_186:
	...
	mov	qword ptr [rip + label_189], OFFSET FLAT:slot0
.label_190:
...
quotearg_char_mem:
	...
	mov	r8, rsi
	mov	rdx, rdi
	mov	rsi, qword ptr [rip + label_202]
	mov	qword ptr [rsp + 0x30], rsi
	movups	xmm0, xmmword ptr [rip + label_203]
	movaps	xmmword ptr [rsp + 0x20], xmm0
	movups	xmm0, xmmword ptr [rip + label_204]
	movaps	xmmword ptr [rsp + 0x10], xmm0
...
quotearg_char:
	...
	mov	ecx, esi
	mov	rax, rdi
	mov	rdx, qword ptr [rip + label_202]
...
quotearg_colon:
	sub	rsp, 0x38
	mov	rax, rdi
	mov	rcx, qword ptr [rip + label_202]
...
quotearg_n_custom:
	...
	sub	rsp, 0x38
	mov	rax, qword ptr [rip + label_202]
