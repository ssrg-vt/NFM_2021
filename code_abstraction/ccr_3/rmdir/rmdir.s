...
.label_208:
	...
	mov	qword ptr [rip + label_212], OFFSET FLAT:slot0
.label_211:
...
quotearg_char_mem:
	...
	mov	r8, rsi
	mov	rdx, rdi
	mov	rsi, qword ptr [rip + label_224]
	mov	qword ptr [rsp + 0x30], rsi
	movups	xmm0, xmmword ptr [rip + label_225]
	movaps	xmmword ptr [rsp + 0x20], xmm0
	movups	xmm0, xmmword ptr [rip + label_226]
	movaps	xmmword ptr [rsp + 0x10], xmm0
...
quotearg_char:
	...
	mov	ecx, esi
	mov	rax, rdi
	mov	rdx, qword ptr [rip + label_224]
	mov	qword ptr [rsp + 0x30], rdx
	movups	xmm0, xmmword ptr [rip + label_225]
	movaps	xmmword ptr [rsp + 0x20], xmm0
	movups	xmm0, xmmword ptr [rip + label_226]
...
quotearg_colon:
	sub	rsp, 0x38
	mov	rax, rdi
	mov	rcx, qword ptr [rip + label_224]
