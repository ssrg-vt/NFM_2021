...
quotearg_char_mem:
	...
	mov	r8, rsi
	mov	rdx, rdi
	mov	rsi, qword ptr [rip + label_253]
	mov	qword ptr [rsp + 0x30], rsi
	movups	xmm0, xmmword ptr [rip + label_254]
	movaps	xmmword ptr [rsp + 0x20], xmm0
	movups	xmm0, xmmword ptr [rip + label_255]
	movaps	xmmword ptr [rsp + 0x10], xmm0
...
quotearg_char:
	...
	mov	ecx, esi
	mov	rax, rdi
	mov	rdx, qword ptr [rip + label_253]
...
quotearg_colon:
	sub	rsp, 0x38
	mov	rax, rdi
	mov	rcx, qword ptr [rip + label_253]
...
quotearg_n_custom:
	...
	sub	rsp, 0x38
	mov	rax, qword ptr [rip + label_253]
