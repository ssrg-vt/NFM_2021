...
main:
	...
	mov	qword ptr [rip + prefix], OFFSET FLAT:label_175
	jmp	.label_176
...
.label_122:
	...
	mov	r8d, OFFSET FLAT:label_187
	mov	r9d, OFFSET FLAT:label_188
	xor	eax, eax
	call	version_etc
	xor	edi, edi
	call	exit
...
.label_459:
	...
	mov	qword ptr [rip + label_461], OFFSET FLAT:slot0
.label_463:
...
quotearg_char_mem:
	...
	mov	r8, rsi
	mov	rdx, rdi
	mov	rsi, qword ptr [rip + label_475]
	mov	qword ptr [rsp + 0x30], rsi
	movups	xmm0, xmmword ptr [rip + label_476]
	movaps	xmmword ptr [rsp + 0x20], xmm0
	movups	xmm0, xmmword ptr [rip + label_477]
	movaps	xmmword ptr [rsp + 0x10], xmm0
...
quotearg_char:
	...
	mov	ecx, esi
	mov	rax, rdi
	mov	rdx, qword ptr [rip + label_475]
...
quotearg_colon:
	sub	rsp, 0x38
	mov	rax, rdi
	mov	rcx, qword ptr [rip + label_475]
...
quotearg_n_custom:
	...
	sub	rsp, 0x38
	mov	rax, qword ptr [rip + label_475]
...
.label_995:
	...
	jmp	.label_969
.label_2715:
	movaps	xmm0, xmmword ptr [rip + label_1207]
...
.label_1068:
	...
	cmp	eax, 4
	ja	.label_1080
	jmp	qword ptr [(rax * 8) + label_1226]
.label_2683:
	cmp	rbp, r14
	jl	.label_917
...
.label_677:
	cmp	eax, 0xc
	je	.label_882
	mov	edi, OFFSET FLAT:label_1179
	mov	esi, OFFSET FLAT:label_1180
	mov	edx, 0x46c
	mov	ecx, OFFSET FLAT:label_1181
	call	__assert_fail
.label_1230:
...
.label_1335:
	...
	cmp	rbx, r15
	jae	.label_1332
	mov	edi, OFFSET FLAT:label_1338
	mov	esi, OFFSET FLAT:label_1180
	mov	edx, 0x1fb
	mov	ecx, OFFSET FLAT:label_1313
	call	__assert_fail
.label_1339:
	mov	rax, qword ptr [r14]
	mov	r13d, 1
...
.label_1331:
	...
	jmp	.label_1306
.label_1307:
	mov	edi, OFFSET FLAT:label_1312
	mov	esi, OFFSET FLAT:label_1180
	mov	edx, 0x1f9
	mov	ecx, OFFSET FLAT:label_1313
	call	__assert_fail
.label_1310:
	...
	mov	esi, OFFSET FLAT:label_1180
	mov	edx, 0x1be
	mov	ecx, OFFSET FLAT:label_1327
	call	__assert_fail
.label_1334:
	mov	rdi, qword ptr [rsp + 0x20]
	jmp	.label_1322
...
.label_1382:
	...
	movdqa	xmm7, xmmword ptr [rip + label_1361]
	movdqa	xmm8, xmmword ptr [rip + label_1014]
	movdqa	xmm9, xmmword ptr [rip + label_1015]
	movdqa	xmm10, xmmword ptr [rip + label_1362]
	pxor	xmm6, xmm10
	pshufd	xmm13, xmmword ptr [rip + label_1363],  0xe8
	mov	rdi, r8
.label_1408:
	movdqa	xmm4, xmm7
	paddq	xmm4, xmm8
...
.label_1500:
	...
	cmp	cl, 0x73
	ja	.label_720
	jmp	qword ptr [(rcx * 8) + label_1526]
.label_2689:
	mov	rcx, r12
	test	ch, 8
	je	.label_720
...
.label_1539:
	...
	cmp	cl, 0x56
	ja	.label_720
	jmp	qword ptr [(rcx * 8) + label_1580]
.label_2809:
	mov	rcx, r12
	test	ch, 0x40
	jne	.label_720
...
parse_expression:
	...
	jmp	qword ptr [(rcx * 8) + label_1618]
.label_2749:
	mov	rsi, qword ptr [r8 + 0x78]
	xor	r8d, r8d
	cmp	al, 0x21
	sete	r8b
	mov	edx, OFFSET FLAT:label_1242
	mov	ecx, OFFSET FLAT:label_1243
	jmp	.label_1244
.label_2750:
	mov	rsi, qword ptr [r8 + 0x78]
	xor	r8d, r8d
...
.label_2746:
	...
	mov	ebp, 0
	jne	.label_851
	movdqa	xmm0, xmmword ptr [rip + label_857]
...
.label_1047:
	...
	cmp	ebp, 3
	ja	.label_1106
	jmp	qword ptr [(rax * 8) + label_1110]
.label_2673:
...
.label_1648:
	...
	cmp	al, 8
	ja	.label_762
	jmp	qword ptr [(rax * 8) + label_1650]
.label_2739:
	mov	eax, 7
...
build_charclass:
	...
	test	r9d, 0x400000
	je	.label_1664
	mov	esi, OFFSET FLAT:label_1658
	mov	rdi, r12
	call	strcmp
	test	eax, eax
	je	.label_1659
	...
	jne	.label_1664
.label_1659:
	mov	r12d, OFFSET FLAT:label_1663
.label_1664:
	mov	rbp, qword ptr [r13]
...
.label_1713:
	...
	test	eax, eax
	je	.label_1692
	mov	esi, OFFSET FLAT:label_1694
	mov	rdi, r12
	call	strcmp
	test	eax, eax
	je	.label_1697
	...
	test	eax, eax
	je	.label_1699
	mov	esi, OFFSET FLAT:label_1702
	mov	rdi, r12
	call	strcmp
	test	eax, eax
	je	.label_1704
	mov	esi, OFFSET FLAT:label_1706
	mov	rdi, r12
	call	strcmp
	test	eax, eax
	je	.label_1708
	mov	esi, OFFSET FLAT:label_1710
	mov	rdi, r12
	call	strcmp
	test	eax, eax
	je	.label_1712
	mov	esi, OFFSET FLAT:label_1714
	mov	rdi, r12
	call	strcmp
	mov	ecx, eax
	mov	eax, 4
...
link_nfa_nodes:
	...
	ja	.label_1739
	xor	eax, eax
	jmp	qword ptr [(rbx * 8) + label_1740]
.label_2688:
	mov	r14, qword ptr [rdi + 0x28]
	lea	rbx, [rcx + rcx*2]
	mov	rax, qword ptr [rsi + 0x20]
	mov	r15, qword ptr [rax + 0x38]
	movaps	xmm0, xmmword ptr [rip + label_298]
...
.label_2686:
	...
	mov	eax, 0
	je	.label_1512
	mov	edi, OFFSET FLAT:label_1513
	mov	esi, OFFSET FLAT:label_906
	mov	edx, 0x59f
...
.label_1533:
	...
	jmp	.label_1524
.label_1743:
	mov	edi, OFFSET FLAT:label_1745
	mov	esi, OFFSET FLAT:label_906
	mov	edx, 0x5af
	mov	ecx, OFFSET FLAT:label_1514
	call	__assert_fail
.label_1746:
	mov	edi, OFFSET FLAT:label_1744
	mov	esi, OFFSET FLAT:label_906
	mov	edx, 0x5b0
	mov	ecx, OFFSET FLAT:label_1514
	call	__assert_fail
.label_1520:
	mov	edi, OFFSET FLAT:label_1573
	mov	esi, OFFSET FLAT:label_906
	mov	edx, 0x5c2
	mov	ecx, OFFSET FLAT:label_1514
	call	__assert_fail
...
set_regs:
	...
	mov	rbx, rdx
	mov	r12, rsi
	mov	rax, qword ptr [rip + label_1989]
	mov	qword ptr [rbp - 0xa0], rax
	movups	xmm0, xmmword ptr [rip + label_1990]
...
.label_1994:
	...
	mov	esi, OFFSET FLAT:label_1180
	mov	edx, 0x555
	mov	ecx, OFFSET FLAT:label_2005
	call	__assert_fail
	nop	word ptr cs:[rax + rax]
	.section	.text
	.align	16
...
check_node_accept:
	...
	cmp	bpl, 6
	ja	.label_2339
	jmp	qword ptr [(rbp * 8) + label_2346]
.label_2733:
	cmp	byte ptr [rsi], cl
	je	.label_2341
	xor	eax, eax
...
.label_2368:
	...
	movdqa	xmm0, xmmword ptr [rip + label_298]
...
hard_locale:
	...
	je	.label_2640
.label_2643:
	mov	esi, OFFSET FLAT:label_2642
	mov	rdi, rax
	call	strcmp
	test	eax, eax
	jne	.label_2641
...
locale_charset:
	...
	cmovne	rcx, rax
	cmp	byte ptr [rcx], 0
	mov	eax, OFFSET FLAT:label_2644
	cmovne	rax, rcx
	pop	rcx
	ret	
	nop	word ptr cs:[rax + rax]
