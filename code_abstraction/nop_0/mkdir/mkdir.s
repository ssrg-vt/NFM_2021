...
.label_430:
	...
	mov	rcx,  qword ptr [word ptr [label_423]]
...
savewd_restore:
	...
	ja	.label_479
	mov	rax, qword ptr [rbp - 0x40]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_476]]
	jmp	rcx
.label_405f6a:
	jmp     .label_481
	.section        .text
...
.label_478:
	...
	movabs  rsi, OFFSET FLAT:.str.1_2
	mov     edx, 0xd8
	movabs  rcx, OFFSET FLAT:__PRETTY_FUNCTION__.savewd_restore
	call    __assert_fail
.label_480:
	jmp     .label_477
.label_483:
...
.label_489:
	...
	movabs  rsi, OFFSET FLAT:.str.1_2
	mov     edx, 0xf7
	movabs  rcx, OFFSET FLAT:__PRETTY_FUNCTION__.savewd_finish
	call    __assert_fail
.label_490:
	jmp     .label_487
.label_486:
