...
check_tuning:
	...
	jmp	.label_222
.label_223:
	movss	xmm0,  dword ptr [dword ptr [label_219]]
	...
	ucomiss	xmm1, xmm0
	jbe	.label_220
	movss	xmm0,  dword ptr [dword ptr [label_221]]
	mov	rax, qword ptr [rbp - 0x18]
	movss	xmm1, dword ptr [rax + 8]
...
compute_bucket_size:
	...
	jne	.label_224
	movss	xmm0,  dword ptr [dword ptr [label_229]]
	mov	rax, qword ptr [rbp - 0x10]
	mov	rcx, rax
	shr	rcx, 1
	mov	edx, eax
...
.label_227:
	movss	xmm0, dword ptr [rbp - 0x1c]
	movss	xmm1,  dword ptr [dword ptr [rip + label_225]]
	movaps	xmm2, xmm0
	subss	xmm2, xmm1
	cvttss2si	rax, xmm2
...
.label_292:
	...
	movss	xmm1,  dword ptr [dword ptr [label_229]]
...
.label_567:
	...
	mov	qword ptr [word ptr [label_565]],  rax
.label_568:
...
.label_575:
	...
	mov	rcx,  qword ptr [word ptr [label_565]]
	mov	qword ptr [rax + 8], rcx
.label_574:
	xor	esi, esi
	mov	rax, qword ptr [rbp - 0x30]
