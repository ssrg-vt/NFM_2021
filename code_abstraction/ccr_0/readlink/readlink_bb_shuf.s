...
.label_26:
	...
	movss	xmm1,  dword ptr [dword ptr [rip + label_12]]
	movaps	xmm2, xmm0
	subss	xmm2, xmm1
	cvttss2si	rax, xmm2
...
hash_reset_tuning:
	...
	mov	rax,  qword ptr [word ptr [label_124]]
	mov	qword ptr [rdi + 8], rax
	mov	ecx,  dword ptr [dword ptr [label_125]]
...
.label_297:
	...
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_366]]
	jmp	rcx
.label_306:
	cmp	qword ptr [rbp - 0x20], 0
	je	.label_369
...
.label_469:
	movss	xmm0, dword ptr [rbp - 0xac]
	movss	xmm1,  dword ptr [dword ptr [rip + label_464]]
...
hash_print_statistics:
	...
	mov	rbp, rsp
	sub	rsp, 0x50
	movabs	rax, OFFSET FLAT:label_511
	mov	qword ptr [rbp - 8], rdi
	mov	qword ptr [rbp - 0x10], rsi
	mov	rdi, qword ptr [rbp - 8]
	mov	qword ptr [rbp - 0x38], rax
	...
	mov	rdx, qword ptr [rbp - 0x28]
	movq	xmm0, rdx
	movaps	xmm1,  xmmword ptr [word ptr [rip + label_514]]
	punpckldq	xmm0, xmm1
	movapd	xmm2,  xmmword ptr [word ptr [rip + label_515]]
	subpd	xmm0, xmm2
	pshufd	xmm3, xmm0, 0x4e
	addpd	xmm3, xmm0
	movsd	xmm0,  qword ptr [word ptr [rip + label_516]]
	mulsd	xmm3, xmm0
...
.label_574:
	...
	mov	rcx,  qword ptr [word ptr [label_573]]
	mov	qword ptr [rax + 8], rcx
.label_569:
	xor	esi, esi
	mov	rax, qword ptr [rbp - 0x30]
...
.label_595:
	...
	call	quotearg_colon
	xor	edi, edi
	movabs	rdx, OFFSET FLAT:label_597
...
version_etc_arn:
	...
	cmp	qword ptr [rbp - 0x20], 0
	je	.label_621
	movabs	rsi, OFFSET FLAT:label_619
	mov	rdi, qword ptr [rbp - 0x18]
	mov	rdx, qword ptr [rbp - 0x20]
	mov	rcx, qword ptr [rbp - 0x28]
	mov	r8, qword ptr [rbp - 0x30]
...
.label_608:
	...
	ja	.label_618
	mov	rax, qword ptr [rbp - 0x60]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_605]]
	jmp	rcx
.label_624:
...
check_tuning:
	...
	jmp	.label_625
.label_627:
	movss	xmm0,  dword ptr [dword ptr [rip + label_626]]
	...
	ucomiss	xmm1, xmm0
	jbe	.label_624
	movss	xmm0,  dword ptr [dword ptr [rip + label_623]]
	mov	rax, qword ptr [rbp - 0x18]
	movss	xmm1, dword ptr [rax + 8]
...
.label_659:
	...
	mov	qword ptr [word ptr [label_573]],  rax
.label_657:
	movabs	rax, OFFSET FLAT:slotvec0
...
compute_bucket_size:
	...
	jne	.label_712
	movss	xmm0,  dword ptr [dword ptr [rip + label_464]]
	mov	rax, qword ptr [rbp - 0x10]
	mov	rcx, rax
	shr	rcx, 1
	mov	edx, eax
...
.label_780:
	...
	movabs	r8, OFFSET FLAT:label_779
	xor	eax, eax
	mov	r9d, eax
	mov	rdi,  qword ptr [word ptr [stdout]]
...
main:
	...
	mov	dword ptr [rbp - 0x4c], eax
.label_771:
	movabs	rdx, OFFSET FLAT:label_766
