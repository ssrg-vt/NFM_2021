...
hextobin:
	...
	ja	.label_99
	mov	rax, qword ptr [rbp - 0x10]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_101]]
	jmp	rcx
.label_99:
...
.label_103:
	call	__errno_location
	xor	edi, edi
	movabs	rdx, OFFSET FLAT:label_108
	mov	esi, dword ptr [rax]
...
.label_246:
	...
	jmp	.label_252
.label_252:
	movabs	rax, OFFSET FLAT:label_203
	mov	qword ptr [rbp - 0x70], rax
	mov	qword ptr [rbp - 0x78], 1
	jmp	.label_187
.label_503:
...
.label_340:
	...
	mov	qword ptr [word ptr [label_341]],  rax
.label_342:
...
.label_350:
	...
	mov	rcx,  qword ptr [word ptr [label_341]]
...
.label_353:
	...
	movabs	rcx, OFFSET FLAT:label_361
	mov	rdx, qword ptr [rbp - 0x10]
	movsx	esi, byte ptr [rdx]
	cmp	esi, 0x60
	cmove	rax, rcx
...
version_etc_arn:
	...
	jmp	.label_365
.label_381:
	movabs	rsi, OFFSET FLAT:label_368
	mov	rdi, qword ptr [rbp - 0x18]
	mov	rdx, qword ptr [rbp - 0x28]
	mov	rcx, qword ptr [rbp - 0x30]
	mov	al, 0
...
.label_365:
	...
	ja	.label_380
	mov	rax, qword ptr [rbp - 0x60]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_370]]
	jmp	rcx
.label_511:
	jmp	.label_369
.label_512:
