...
.label_108:
	...
	jae	.label_109
	mov	rax, qword ptr [rbp - 0x18]
	mov	cx,  word ptr [word ptr [label_106]]
	mov	word ptr [rax], cx
	mov	dl,  byte ptr [byte ptr [label_107]]
...
.label_324:
	...
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_163]]
	jmp	rcx
.label_528:
	test	byte ptr [rbp - 0x79], 1
	je	.label_164
...
.label_380:
	...
	ja	.label_396
	mov	rax, qword ptr [rbp - 0x60]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_386]]
	jmp	rcx
.label_562:
	jmp	.label_385
.label_563:
