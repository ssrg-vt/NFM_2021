...
.label_45:
	...
	movabs	r9, OFFSET FLAT:label_54
...
.label_95:
	...
	jmp	.label_102
.label_101:
	movabs	rax, OFFSET FLAT:label_60
...
.label_379:
	call	locale_charset
	movabs	rsi, OFFSET FLAT:label_377
	mov	qword ptr [rbp - 0x28], rax
	mov	rdi, qword ptr [rbp - 0x28]
	call	c_strcasecmp
	cmp	eax, 0
	...
	movabs	rcx, OFFSET FLAT:label_382
	mov	rdx, qword ptr [rbp - 0x10]
	movsx	esi, byte ptr [rdx]
	cmp	esi, 0x60
	cmove	rax, rcx
...
version_etc_arn:
	...
	cmp	qword ptr [rbp - 0x20], 0
	je	.label_383
	movabs	rsi, OFFSET FLAT:label_399
	mov	rdi, qword ptr [rbp - 0x18]
	mov	rdx, qword ptr [rbp - 0x20]
	mov	rcx, qword ptr [rbp - 0x28]
	mov	r8, qword ptr [rbp - 0x30]
