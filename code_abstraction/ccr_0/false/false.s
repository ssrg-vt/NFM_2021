...
.label_200:
	...
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_103]]
	jmp	rcx
.label_536:
...
.label_278:
	...
	mov	qword ptr [word ptr [label_279]],  rax
.label_280:
...
.label_281:
	...
	mov	rcx,  qword ptr [word ptr [label_279]]
...
.label_296:
	...
	cmp	eax, 0
	jne	.label_295
	movabs	rax, OFFSET FLAT:label_298
	movabs	rcx, OFFSET FLAT:label_299
	mov	rdx, qword ptr [rbp - 0x10]
...
.label_295:
	...
	movabs	rcx, OFFSET FLAT:label_291
	mov	rdx, qword ptr [rbp - 0x10]
	movsx	esi, byte ptr [rdx]
	cmp	esi, 0x60
	cmove	rax, rcx
...
.label_297:
	movabs	rax, OFFSET FLAT:label_141
	movabs	rcx, OFFSET FLAT:label_123
...
version_etc_arn:
	...
	jmp	.label_307
.label_300:
	movabs	rsi, OFFSET FLAT:label_308
	mov	rdi, qword ptr [rbp - 0x18]
	mov	rdx, qword ptr [rbp - 0x28]
	mov	rcx, qword ptr [rbp - 0x30]
	mov	al, 0
