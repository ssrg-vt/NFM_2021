...
.label_268:
	...
	mov	qword ptr [word ptr [label_240]],  rax
.label_269:
	movabs	rax, OFFSET FLAT:slotvec0
...
.label_274:
	...
	xor	ebx, ebx
	mov	r14d, ebx
	movabs	r15, OFFSET FLAT:label_278
	movabs	r12, OFFSET FLAT:label_261
...
.label_314:
	...
	movabs	rcx, OFFSET FLAT:label_308
	mov	rdx, qword ptr [rbp - 0x10]
...
.label_306:
	movabs	rax, OFFSET FLAT:label_138
	movabs	rcx, OFFSET FLAT:label_112
...
main:
	...
	movabs	rcx, OFFSET FLAT:label_260
	mov	r9d, 1
...
.label_361:
	...
	jne	.label_360
	movabs	rdx, OFFSET FLAT:label_278
...
.label_374:
	call	__errno_location
	xor	edi, edi
	movabs	rdx, OFFSET FLAT:label_370
	mov	esi, dword ptr [rax]
	mov	rcx, qword ptr [rbp - 8]
	mov	al, 0
	call	error
...
.label_372:
	...
	call	quotearg_colon
	xor	edi, edi
	movabs	rdx, OFFSET FLAT:label_377
