...
.label_83:
	...
	mov	qword ptr [word ptr [label_81]],  rax
.label_79:
...
.label_106:
	...
	xor	ebx, ebx
	mov	r14d, ebx
	movabs	r15, OFFSET FLAT:label_103
	movabs	r12, OFFSET FLAT:label_104
...
locale_charset:
	...
	cmp	qword ptr [rbp - 8], 0
	jne	.label_146
	movabs	rax, OFFSET FLAT:label_104
	mov	qword ptr [rbp - 8], rax
.label_146:
	mov	rax, qword ptr [rbp - 8]
	movsx	ecx, byte ptr [rax]
...
emit_bug_reporting_address:
	...
	mov	dword ptr [rbp - 4], eax
	call	gettext
	movabs	rsi, OFFSET FLAT:label_158
...
.label_180:
	...
	call	umask
	movabs	rcx, OFFSET FLAT:label_188
	movabs	rdx, OFFSET FLAT:label_189
...
.label_203:
	...
	jne	.label_206
	movabs	rax, OFFSET FLAT:label_208
	movabs	rcx, OFFSET FLAT:label_209
...
main:
	...
	call	atexit
	movabs	rdx, OFFSET FLAT:label_85
	movabs	rcx, OFFSET FLAT:label_158
	xor	r9d, r9d
...
.label_178:
	...
	je	.label_203
.label_200:
	movabs	rax, OFFSET FLAT:label_205
	mov	qword ptr [rbp - 0x30], 0
	mov	qword ptr [rbp - 0x38], rax
...
.label_294:
	...
	mov	rcx,  qword ptr [word ptr [label_81]]
	mov	qword ptr [rax + 8], rcx
.label_299:
	xor	esi, esi
	mov	rax, qword ptr [rbp - 0x30]
...
xalloc_die:
	...
	call	gettext
	xor	esi, esi
	movabs	rdx, OFFSET FLAT:label_527
	mov	edi, dword ptr [rbp - 4]
	mov	rcx, rax
	mov	al, 0
	call	error
...
.label_539:
	...
	call	quotearg_colon
	xor	edi, edi
	movabs	rdx, OFFSET FLAT:label_544
