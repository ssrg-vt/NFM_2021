...
.label_48:
	...
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_75]]
	jmp	rcx
.label_719:
...
.label_379:
	...
	jmp	.label_184
.label_184:
	movabs	rax, OFFSET FLAT:label_187
...
.label_386:
	...
	mov	qword ptr [word ptr [label_385]],  rax
.label_387:
...
.label_388:
	...
	mov	rcx,  qword ptr [word ptr [label_385]]
...
.label_403:
	...
	cmp	eax, 0
	jne	.label_402
	movabs	rax, OFFSET FLAT:label_405
...
.label_482:
	...
	mov	edx, 0x54
	movabs	rcx, OFFSET FLAT:label_509
	call	__assert_fail
.label_506:
	cmp	qword ptr [rbp - 0x18], 0
	je	.label_478
...
c_ispunct:
	...
	ja	.label_580
	mov	rax, qword ptr [rbp - 0x10]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_582]]
	jmp	rcx
.label_679:
	mov	byte ptr [rbp - 1], 1
	jmp	.label_581
