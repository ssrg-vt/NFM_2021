...
usage:
	...
	mov	rbp, rsp
	sub	rsp, 0x20
	movabs	rax, OFFSET FLAT:label_20
	mov	dword ptr [rbp - 4], edi
	mov	rdi, rax
	call	gettext
...
.label_170:
	...
	call	quotearg_colon
	xor	edi, edi
	movabs	rdx, OFFSET FLAT:label_171
