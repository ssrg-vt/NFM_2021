...
.label_41:
	...
	mov	qword ptr [word ptr [label_42]],  rax
.label_43:
...
.label_70:
	...
	mov	rcx,  qword ptr [word ptr [label_42]]
...
.label_302:
	...
	ja	.label_245
	mov	rax, qword ptr [rbp - 0xf0]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_253]]
	jmp	rcx
.label_399:
	jmp	.label_252
.label_252:
...
.label_423:
	...
	movabs	rdx, OFFSET FLAT:label_421
	mov	rdi, rax
	mov	al, 0
	call	printf
	mov	edi, 5
...
.label_447:
	...
	mov	edx, 0x147
	movabs	rcx, OFFSET FLAT:label_443
	call	__assert_fail
.label_448:
...
.label_453:
	...
	call	quotearg_colon
	xor	edi, edi
	movabs	rdx, OFFSET FLAT:label_458
...
.label_471:
	...
	movabs	rcx, OFFSET FLAT:label_475
	mov	rdx, qword ptr [rbp - 0x10]
...
try_dir:
	...
	#Procedure 0x406bd6
	.globl sub_406bd6
	.type sub_406bd6, @function
sub_406bd6:

	nop	word ptr cs:[rax + rax]
.label_544:
	movabs	rax, OFFSET FLAT:label_497
...
.label_504:
	...
	movabs	r8, OFFSET FLAT:label_509
	movabs	r9, OFFSET FLAT:label_510
	xor	eax, eax
	mov	ecx, eax
	mov	rdi,  qword ptr [word ptr [stdout]]
...
main:
	...
	mov	dword ptr [rbp - 0xa4], eax
.label_502:
	movabs	rdx, OFFSET FLAT:label_536
