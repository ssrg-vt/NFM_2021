...
.label_38:
	...
	movabs	r8, OFFSET FLAT:label_64
	movabs	r9, OFFSET FLAT:label_65
	xor	eax, eax
	mov	ecx, eax
...
.label_96:
	...
	call	quotearg_colon
	xor	edi, edi
	movabs	rdx, OFFSET FLAT:label_97
...
.label_98:
	call	__errno_location
	xor	edi, edi
	movabs	rdx, OFFSET FLAT:label_99
	mov	esi, dword ptr [rax]
...
.label_151:
	...
	jmp	.label_148
.label_148:
	movabs	rax, OFFSET FLAT:label_164
...
.label_350:
	movabs	rax, OFFSET FLAT:label_181
	movabs	rcx, OFFSET FLAT:label_164
...
.label_360:
	...
	ja	.label_357
	mov	rax, qword ptr [rbp - 0x60]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_365]]
	jmp	rcx
.label_632:
	jmp	.label_356
.label_633:
