...
.label_43:
	...
	mov	rcx,  qword ptr [word ptr [label_37]]
...
.label_87:
	...
	mov	qword ptr [word ptr [label_37]],  rax
.label_88:
	movabs	rax, OFFSET FLAT:slotvec0
...
.label_187:
	...
	movabs	rcx, OFFSET FLAT:label_179
...
.label_184:
	...
	movabs	rcx, OFFSET FLAT:label_189
	mov	rdx, qword ptr [rbp - 0x10]
	movsx	esi, byte ptr [rdx]
	cmp	esi, 0x60
	cmove	rax, rcx
...
.label_212:
	call	__errno_location
	xor	edi, edi
	movabs	rdx, OFFSET FLAT:label_213
	mov	esi, dword ptr [rax]
	mov	rcx, qword ptr [rbp - 8]
	mov	al, 0
	call	error
...
.label_240:
	...
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_252]]
	jmp	rcx
.label_323:
...
.label_270:
	...
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_434]]
	jmp	rcx
.label_403:
	cmp	qword ptr [rbp - 0x20], 0
	jne	.label_437
...
.label_485:
	...
	movabs	r8, OFFSET FLAT:label_479
	movabs	r9, OFFSET FLAT:label_480
	xor	eax, eax
	mov	ecx, eax
	mov	rdi,  qword ptr [word ptr [stdout]]
...
main:
	...
	mov	dword ptr [rbp - 0x3c], eax
.label_490:
	movabs	rdx, OFFSET FLAT:label_474
...
.label_525:
	...
	ja	.label_522
	mov	rax, qword ptr [rbp - 0x60]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_521]]
	jmp	rcx
.label_637:
