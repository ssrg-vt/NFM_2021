...
.label_18:
	...
	mov	qword ptr [word ptr [label_16]],  rax
.label_14:
...
c_ispunct:
	...
	ja	.label_21
	mov	rax, qword ptr [rbp - 0x10]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_20]]
	jmp	rcx
	.section	.text
	.align	32
	#Procedure 0x401570
...
.label_130:
	...
	mov	rcx,  qword ptr [word ptr [label_16]]
...
locale_charset:
	...
	cmp	qword ptr [rbp - 8], 0
	jne	.label_159
	movabs	rax, OFFSET FLAT:label_158
	mov	qword ptr [rbp - 8], rax
.label_159:
	mov	rax, qword ptr [rbp - 8]
...
.label_245:
	...
	movabs	r8, OFFSET FLAT:label_253
	movabs	r9, OFFSET FLAT:label_254
	xor	eax, eax
	mov	ecx, eax
	mov	rdi,  qword ptr [word ptr [stdout]]
