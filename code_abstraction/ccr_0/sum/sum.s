...
human_readable:
	...
	movabs	r9, OFFSET FLAT:label_112
	mov	r10d, 0x3e8
	mov	r11d, 0x400
	mov	qword ptr [rbp - 8], rdi
	mov	qword ptr [rbp - 0x10], rsi
...
.label_99:
	...
	movzx	edx, cl
	mov	eax, edx
	fld	dword ptr [dword ptr [+ (rax * 4) + label_101]]
...
.label_103:
	...
	fld	xword ptr [rbp - 0xe0]
	fld	dword ptr [dword ptr [rip + label_129]]
	fmul	st(1), st(0)
	mov	rsi, rsp
	fxch	st(1)
	fstp	xword ptr [rsi]
...
adjust_value:
	...
	fld	xword ptr [word ptr [rip + label_149]]
	fucomip	st(1)
	fstp	st(0)
	jbe	.label_148
	jmp	.label_150
.label_150:
	...
	mov	cl, al
	fld	xword ptr [rbp - 0x20]
	fld	dword ptr [dword ptr [rip + label_151]]
	fld	st(1)
	fsub	st(1)
...
.label_152:
	...
	movzx	ecx, al
	mov	edx, ecx
	fld	dword ptr [dword ptr [+ (rdx * 4) + label_101]]
...
.label_173:
	lea	rsi, [rbp - 0x30]
	xor	edx, edx
	movabs	r8, OFFSET FLAT:label_176
	mov	rdi, qword ptr [rbp - 0x10]
	mov	rcx, qword ptr [rbp - 0x18]
	call	xstrtoumax
	mov	dword ptr [rbp - 0x34], eax
...
.label_412:
	...
	mov	qword ptr [word ptr [label_411]],  rax
.label_413:
...
.label_420:
	...
	mov	rcx,  qword ptr [word ptr [label_411]]
...
.label_426:
	movabs	rax, OFFSET FLAT:label_233
	movabs	rcx, OFFSET FLAT:label_315
...
emit_bug_reporting_address:
	...
	call	gettext
	movabs	rsi, OFFSET FLAT:label_473
	mov	rdi, rax
	mov	al, 0
	call	printf
...
.label_570:
	...
	mov	rdi, rax
	call	quote
	movabs	rsi, OFFSET FLAT:label_568
	mov	rdi, qword ptr [rbp - 0x38]
	mov	rdx, rax
	mov	al, 0
	call	fprintf
