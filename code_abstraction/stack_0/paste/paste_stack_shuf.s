...
.label_113:
	...
	mov	cl, al
	mov	byte ptr [rbp - 0x6e], cl
	nop	
	movsx	edi, byte ptr [rbp - 0x6e]
	nop	
	call	xputchar
.label_109:
	jmp	.label_76
...
.label_202:
	...
	lea	rdi, [rdi]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_274]]
	jmp	rcx
.label_505:
...
.label_352:
	...
	mov	rbp, rbp
	mov	qword ptr [word ptr [label_349]],  rax
.label_351:
...
.label_360:
	...
	mov	rcx,  qword ptr [word ptr [label_349]]
	mov	rbp, rbp
