...
.label_749:
	...
	mov	eax, edx
	nop	
	fld	dword ptr [dword ptr [+ (rax * 4) + label_770]]
	mov	rsp, rsp
...
.label_753:
	...
	fld	xword ptr [rbp - 0x190]
	mov	rsp, rsp
	fld	dword ptr [dword ptr [rip + label_784]]
	mov	rbp, rbp
	fmul	st(1), st(0)
	mov	rsp, rsp
	mov	rsi, rsp
...
.label_797:
	...
	mov	edx, ecx
	nop	
	fld	dword ptr [dword ptr [+ (rdx * 4) + label_770]]
	mov	rsp, rsp
	fild	qword ptr [rbp - 0x50]
	faddp	st(1)
	mov	rsp, rsp
...
.label_981:
	...
	mov	rax, qword ptr [rbp - 0x70]
	lea	rsi, [rsi]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_1052]]
	nop	
	jmp	rcx
.label_1562:
	mov	rbp, rbp
