...
.label_510:
	...
	mov	eax, edx
	nop	
	fld	dword ptr [dword ptr [+ (rax * 4) + label_512]]
	mov	rsp, rsp
...
.label_544:
	...
	fld	xword ptr [rbp - 0x190]
	mov	rsp, rsp
	fld	dword ptr [dword ptr [rip + label_529]]
	mov	rbp, rbp
	fmul	st(1), st(0)
	mov	rsp, rsp
	mov	rsi, rsp
...
.label_554:
	...
	mov	edx, ecx
	nop	
	fld	dword ptr [dword ptr [+ (rdx * 4) + label_512]]
	mov	rsp, rsp
	fild	qword ptr [rbp - 0x50]
	faddp	st(1)
	mov	rsp, rsp
...
.label_628:
	...
	mov	rax, qword ptr [rbp - 0x70]
	lea	rsi, [rsi]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_696]]
	nop	
	jmp	rcx
.label_1141:
	mov	rbp, rbp
...
.label_840:
	...
	ja	.label_841
	mov	rax, qword ptr [rbp - 0x148]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_839]]
	jmp	rcx
.label_1202:
	jmp	.label_838
.label_1203:
