...
main:
	...
	lea	rdi, [rdi]
	mov	byte ptr [byte ptr [label_23]],  0
...
.label_47:
	...
	nop	
	jne	.label_20
	test	byte ptr [byte ptr [label_23]],  1
	je	.label_27
.label_20:
	mov	rbp, rbp
...
compare_files:
	...
	call	memset
	nop	
	mov	dword ptr [rbp - 0x1e8], 0
.label_50:
	lea	rdi, [rdi]
	cmp	dword ptr [rbp - 0x1e8], 2
	jge	.label_84
	mov	rbp, rbp
	mov	dword ptr [rbp - 0x16c], 0
.label_55:
	cmp	dword ptr [rbp - 0x16c], 4
	jge	.label_90
	lea	rsi, [rsi]
	lea	rax, [rbp - 0x120]
	movsxd	rcx, dword ptr [rbp - 0x16c]
	mov	rsp, rsp
	movsxd	rdx, dword ptr [rbp - 0x1e8]
	imul	rdx, rdx, 0x60
	lea	rsi, [rsi]
	add	rax, rdx
	mov	rbp, rbp
	...
	lea	rcx, [rbp - 0x120]
	nop	
	movsxd	rdx, dword ptr [rbp - 0x16c]
	movsxd	rdi, dword ptr [rbp - 0x1e8]
	mov	rbp, rbp
	imul	rdi, rdi, 0x60
	add	rcx, rdi
	imul	rdx, rdx, 0x18
...
.label_90:
	lea	rax, [rbp - 0x50]
	mov	rsp, rsp
	movsxd	rcx, dword ptr [rbp - 0x1e8]
	nop	
	imul	rcx, rcx, 0xc
	mov	rsp, rsp
	mov	rdx, rax
	...
	lea	rsi, [rsi]
	movsxd	rax, dword ptr [rbp - 0x1e8]
	lea	rsi, [rsi]
...
.label_89:
	...
	mov	rbp, rbp
	movsxd	rcx, dword ptr [rbp - 0x1e8]
	mov	qword ptr [rbp + rcx*8 - 0x30], rax
	movsxd	rax, dword ptr [rbp - 0x1e8]
	cmp	qword ptr [rbp + rax*8 - 0x30], 0
	jne	.label_79
	lea	rdi, [rdi]
...
.label_79:
	...
	lea	rdi, [rdi]
	movsxd	rax, dword ptr [rbp - 0x1e8]
	mov	rdi, qword ptr [rbp + rax*8 - 0x30]
	call	fadvise
	lea	rax, [rbp - 0x1e0]
	lea	rdi, [rbp - 0x50]
	movsxd	rcx, dword ptr [rbp - 0x1e8]
	...
	movsxd	rax, dword ptr [rbp - 0x1e8]
	nop	
	mov	rsi, qword ptr [rbp + rax*8 - 0x30]
	mov	rbp, rbp
	...
	movsxd	rcx, dword ptr [rbp - 0x1e8]
	lea	rsi, [rsi]
	mov	qword ptr [rbp + rcx*8 - 0x190], rax
	nop	
	movsxd	rax, dword ptr [rbp - 0x1e8]
	lea	rsi, [rsi]
	mov	rdi, qword ptr [rbp + rax*8 - 0x30]
...
.label_52:
	...
	jg	.label_54
	nop	
	mov	byte ptr [rbp - 0x251], 1
.label_54:
	mov	rsp, rsp
	cmp	dword ptr [rbp - 0x5c], 0
	mov	rbp, rbp
	jg	.label_62
	mov	byte ptr [rbp - 0x252], 1
.label_62:
	mov	rbp, rbp
	mov	dword ptr [rbp - 0x1e8], 0
.label_81:
	...
	movsxd	rax, dword ptr [rbp - 0x1e8]
	mov	rsp, rsp
	cmp	qword ptr [rbp + rax*8 - 0x190], 0
	je	.label_74
	lea	rax, [rbp - 0x1e0]
	lea	rcx, [rbp - 0x50]
	movsxd	rdx, dword ptr [rbp - 0x1e8]
	...
	movsxd	rax, dword ptr [rbp - 0x1e8]
	lea	rsi, [rsi]
	mov	rsi, qword ptr [rbp + rax*8 - 0x190]
	mov	rsp, rsp
	mov	r8d, dword ptr [rbp - 0x1e8]
	add	r8d, 1
	mov	edx, r8d
	call	check_order
	jmp	.label_56
.label_74:
	...
	movsxd	rsi, dword ptr [rbp - 0x1e8]
	shl	rsi, 5
	mov	rdi, rax
	add	rdi, rsi
	nop	
