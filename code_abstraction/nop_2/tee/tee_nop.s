...
.label_39:
	...
	test	ebp, ebp
	nop	
	mov	qword ptr [rsp + 0x2040], rbp
	jle	.label_37
	nop	
	mov	qword ptr [rsp + 0x10], r15
	nop	
	mov	qword ptr [rsp + 0x2030], r14
	lea	rsi, [rsi]
	mov	rax, r13
	lea	rsi, [rsi]
	mov	qword ptr [rsp + 0x2058], rax
	mov	r13d, r15d
	lea	rdi, [rdi]
	sub	r13d, ebx
	lea	rdi, [rdi]
...
.label_28:
	...
	mov	r14, qword ptr [rsp + 0x2030]
	mov	r13, qword ptr [rsp + 0x2058]
	nop	
	mov	rbx, qword ptr [rsp + 0x2038]
	mov	rsp, rsp
	je	.label_13
.label_37:
	lea	rsi, [rsi]
	mov	qword ptr [rsp + 0x2060], r12
	nop	
	mov	qword ptr [rsp + 0x2038], rbx
	mov	rsp, rsp
	lea	eax, [r15 + 1]
	sub	eax, ebx
	lea	rsi, [rsi]
	mov	dword ptr [rsp + 0x204c], eax
	lea	rax, [r14 + rbx*8 - 8]
	mov	qword ptr [rsp + 0x2050], rax
	lea	rbp, [rsp + 0x20]
	mov	r12, qword ptr [rsp + 0x2040]
.label_10:
	lea	rdi, [rdi]
	xor	edi, edi
	mov	edx, 0x2000
	...
	mov	r12, r13
	nop	
	mov	qword ptr [rsp + 0x2058], r13
	mov	r14d, dword ptr [rsp + 0x204c]
	mov	r13, qword ptr [rsp + 0x2050]
	nop	dword ptr [rax]
.label_38:
...
.label_106:
	...
	mov	rbp, r13
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_81]]
.label_363:
	lea	rsi, [rsi]
...
.label_99:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r15 * 8) + label_130]]
.label_347:
	mov	rsp, rsp
	test	rdi, rdi
	mov	rbp, rbp
...
.label_237:
	...
	ja	.label_233
	lea	rsi, [rsi]
	jmp	qword ptr [word ptr [+ (r12 * 8) + label_229]]
.label_321:
	lea	rdi, [rdi]
	xor	edi, edi
	mov	rsp, rsp
