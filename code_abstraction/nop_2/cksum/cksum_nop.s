...
cksum:
	...
	sub	rsp, 0x10090
	mov	al, sil
	mov	qword ptr [rbp - 0x10080], rdi
	and	al, 1
	mov	byte ptr [rbp - 0x10029], al
	lea	rdi, [rdi]
	mov	qword ptr [rbp - 0x10040], 0
	lea	rdi, [rdi]
	mov	qword ptr [rbp - 0x10068], 0
	lea	rsi, [rsi]
	mov	rdi, qword ptr [rbp - 0x10080]
...
.label_27:
	...
	mov	rdi, qword ptr [rbp - 0x10080]
	call	fopen
	mov	qword ptr [rbp - 0x10018], rax
	cmp	qword ptr [rbp - 0x10018], 0
	lea	rsi, [rsi]
	jne	.label_30
	call	__errno_location
	xor	edi, edi
	...
	mov	dword ptr [rbp - 0x10088], ecx
	mov	rsp, rsp
	call	quotearg_n_style_colon
	lea	rsi, [rsi]
	xor	edi, edi
	movabs	rdx, OFFSET FLAT:.str_1
	mov	esi, dword ptr [rbp - 0x10088]
	mov	rcx, rax
	lea	rdi, [rdi]
	mov	al, 0
	nop	
...
.label_22:
	...
	lea	rdi, [rdi]
	mov	rax, qword ptr [rbp - 0x10068]
	mov	rbp, rbp
	add	rax, qword ptr [rbp - 0x10]
	mov	rsp, rsp
	cmp	rax, qword ptr [rbp - 0x10068]
	mov	rsp, rsp
	jae	.label_31
	lea	rsi, [rsi]
...
.label_32:
	lea	rsi, [rbp - 0x10060]
	mov	rdi, qword ptr [rbp - 0x10068]
	nop	
	call	umaxtostr
	mov	qword ptr [rbp - 0x10028], rax
.label_37:
	cmp	qword ptr [rbp - 0x10068], 0
	je	.label_36
	mov	rax, qword ptr [rbp - 0x10040]
	shl	rax, 8
	mov	rsp, rsp
...
.label_36:
	...
	mov	ecx, eax
	mov	rsp, rsp
	mov	rdx, qword ptr [rbp - 0x10028]
	mov	rbp, rbp
	mov	rax, qword ptr [rbp - 0x10080]
	mov	esi, ecx
	lea	rdi, [rdi]
	mov	rcx, rax
	nop	
...
.label_290:
	...
	mov	rbp, rbp
	mov	qword ptr [word ptr [label_287]],  rax
.label_289:
...
.label_297:
	...
	mov	rcx,  qword ptr [word ptr [label_287]]
	mov	rbp, rbp
