...
.label_35:
	...
	movzx	edi, bpl
	xor	rdi, rsi
	xor	rdx,  qword ptr [word ptr [+ (rdi * 8) + crctab]]
	mov	rbp, rdx
	mov	rdx, r14
.label_36:
	cmp	rax, 1
...
.label_24:
	...
	movzx	edi, bpl
	xor	rdi, rsi
	xor	rax,  qword ptr [word ptr [+ (rdi * 8) + crctab]]
	mov	rbp, rax
	shl	rbp, 8
	shr	rax, 0x18
	...
	movzx	eax, al
	xor	rax, rsi
	xor	rbp,  qword ptr [word ptr [+ (rax * 8) + crctab]]
	add	rdx, 2
	add	rcx, -2
	jne	.label_24
.label_23:
...
.label_139:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r15 * 8) + label_77]]
.label_356:
	test	rdi, rdi
	jne	.label_64
	jmp	.label_86
...
.label_182:
	...
	mov	qword ptr [word ptr [rip + label_186]], OFFSET FLAT:slot0
.label_185:
...
quotearg_char_mem:
	...
	mov	r8, rsi
	mov	rdx, rdi
	mov	rsi,  qword ptr [word ptr [rip + label_198]]
	mov	qword ptr [rsp + 0x30], rsi
	movups	xmm0,  xmmword ptr [word ptr [rip + label_199]]
...
quotearg_char:
	...
	mov	ecx, esi
	mov	rax, rdi
	mov	rdx,  qword ptr [word ptr [rip + label_198]]
...
quotearg_colon:
	sub	rsp, 0x38
	mov	rax, rdi
	mov	rcx,  qword ptr [word ptr [rip + label_198]]
...
quotearg_n_custom:
	...
	sub	rsp, 0x38
	mov	rax,  qword ptr [word ptr [rip + label_198]]
	mov	qword ptr [rsp + 0x30], rax
	movups	xmm0,  xmmword ptr [word ptr [rip + label_199]]
	movaps	xmmword ptr [rsp + 0x20], xmm0
	movups	xmm0,  xmmword ptr [word ptr [rip + label_200]]
