...
.label_7:
	...
	mov	edx, 0x28
	nop	
	movabs	rcx, OFFSET FLAT:__PRETTY_FUNCTION__.usage
	lea	rdi, [rdi]
	call	__assert_fail
.label_8:
	mov	rbp, rbp
...
.label_87:
	...
	jmp	.label_38
.label_83:
	mov	byte ptr [rbp - 0x25], 7
	nop	
	jmp	.label_24
.label_18:
	mov	rbp, rbp
	mov	byte ptr [rbp - 0x25], 8
	jmp	.label_24
.label_23:
	mov	dword ptr [rbp - 0xf8], 0
	jmp	.label_26
.label_32:
	lea	rdi, [rdi]
	mov	byte ptr [rbp - 0x25], 0x1b
	nop	
	jmp	.label_24
.label_44:
	mov	byte ptr [rbp - 0x25], 0xc
	nop	
	jmp	.label_24
.label_55:
...
.label_63:
	mov	rbp, rbp
	mov	byte ptr [rbp - 0x25], 0xd
	mov	rbp, rbp
	jmp	.label_24
.label_28:
	mov	byte ptr [rbp - 0x25], 9
	jmp	.label_24
.label_88:
	mov	byte ptr [rbp - 0x25], 0xb
	mov	rbp, rbp
	jmp	.label_24
.label_77:
	lea	rdi, [rdi]
