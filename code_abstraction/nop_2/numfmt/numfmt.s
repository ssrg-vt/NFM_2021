...
.label_137:
	...
	ja	.label_232
	fstp	st(0)
	jmp	qword ptr [word ptr [+ (rax * 8) + label_233]]
.label_756:
...
.label_452:
	...
	mov	rbp, r13
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_389]]
.label_771:
...
.label_624:
	...
	xor	ebx, ebx
	mov	r13, r12
	jmp	qword ptr [word ptr [+ (rax * 8) + label_589]]
.label_695:
...
.label_644:
	...
	cmp	eax, 0xe
	ja	.label_643
	jmp	qword ptr [word ptr [+ (rax * 8) + label_645]]
.label_797:
	mov	rax, rbp
	shr	rax, 0x36
	setne	dl
