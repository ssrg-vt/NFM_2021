...
.label_158:
	...
	mov	rbp, r13
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_114]]
.label_360:
	lea	rsi, [rsi]
...
.label_132:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r15 * 8) + label_51]]
.label_376:
	mov	rsp, rsp
	test	rdi, rdi
	mov	rbp, rbp
...
quotearg_char_mem:
	...
	mov	rbp, rbp
	mov	rdx, rdi
	mov	rsi,  qword ptr [word ptr [rip + label_181]]
	lea	rdi, [rdi]
	mov	qword ptr [rsp + 0x30], rsi
...
quotearg_char:
	...
	mov	rax, rdi
	mov	rbp, rbp
	mov	rdx,  qword ptr [word ptr [rip + label_181]]
...
quotearg_colon:
	...
	mov	rax, rdi
	lea	rdi, [rdi]
	mov	rcx,  qword ptr [word ptr [rip + label_181]]
	nop	
	mov	qword ptr [rsp + 0x30], rcx
	movups	xmm0,  xmmword ptr [word ptr [rip + label_182]]
	movaps	xmmword ptr [rsp + 0x20], xmm0
...
quotearg_n_custom:
	...
	sub	rsp, 0x38
	nop	
	mov	rax,  qword ptr [word ptr [rip + label_181]]
	mov	rsp, rsp
...
.label_195:
	...
	ja	.label_197
	lea	rsi, [rsi]
	jmp	qword ptr [word ptr [+ (r12 * 8) + label_198]]
.label_333:
	lea	rdi, [rdi]
	xor	edi, edi
	mov	rsp, rsp
...
.label_274:
	...
	mov	rsp, rsp
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (rdx * 8) + label_264]]
.label_366:
	mov	rax, rbp
	shr	rax, 0x37
	lea	rsi, [rsi]
