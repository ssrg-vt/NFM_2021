...
.label_604:
	...
	mov	rbp, qword ptr [rsp + 0x88]
	ja	.label_599
	mov	eax,  dword ptr [dword ptr [+ (rcx * 4) + label_615]]
.label_599:
...
.label_726:
	...
	call	__fprintf_chk
	movq	xmm1, r14
	movdqa	xmm2,  xmmword ptr [word ptr [rip + label_733]]
	punpckldq	xmm1, xmm2
	movapd	xmm3,  xmmword ptr [word ptr [rip + label_734]]
	subpd	xmm1, xmm3
	pshufd	xmm0, xmm1, 0x4e
	addpd	xmm0, xmm1
	mulsd	xmm0,  qword ptr [word ptr [rip + label_735]]
	movq	xmm1, r12
	punpckldq	xmm1, xmm2
	subpd	xmm1, xmm3
...
.label_833:
	...
	mov	eax, OFFSET FLAT:default_tuning
	movss	xmm2,  dword ptr [dword ptr [rip + label_850]]
	jmp	.label_843
.label_859:
	mov	eax, OFFSET FLAT:default_tuning
.label_843:
