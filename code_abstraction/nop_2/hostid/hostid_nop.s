...
.label_55:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r15 * 8) + label_84]]
.label_278:
	mov	rsp, rsp
	test	rdi, rdi
	mov	rbp, rbp
...
.label_152:
	...
	mov	rsp, rsp
	mov	qword ptr [word ptr [rip + label_153]], OFFSET FLAT:slot0
.label_155:
...
quotearg_char_mem:
	...
	mov	rbp, rbp
	mov	rdx, rdi
	mov	rsi,  qword ptr [word ptr [rip + label_168]]
	lea	rdi, [rdi]
	mov	qword ptr [rsp + 0x30], rsi
...
quotearg_char:
	...
	mov	rax, rdi
	mov	rbp, rbp
	mov	rdx,  qword ptr [word ptr [rip + label_168]]
...
quotearg_colon:
	...
	mov	rax, rdi
	lea	rdi, [rdi]
	mov	rcx,  qword ptr [word ptr [rip + label_168]]
	nop	
	mov	qword ptr [rsp + 0x30], rcx
	movups	xmm0,  xmmword ptr [word ptr [rip + label_169]]
	movaps	xmmword ptr [rsp + 0x20], xmm0
...
quotearg_n_custom:
	...
	sub	rsp, 0x38
	nop	
	mov	rax,  qword ptr [word ptr [rip + label_168]]
	mov	rsp, rsp
...
.label_182:
	...
	ja	.label_184
	lea	rsi, [rsi]
	jmp	qword ptr [word ptr [+ (r12 * 8) + label_185]]
.label_285:
	lea	rdi, [rdi]
	xor	edi, edi
	mov	rsp, rsp
