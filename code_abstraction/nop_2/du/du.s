...
.label_29:
	...
	xorps	xmm0, xmm0
	movaps	xmm1,  xmmword ptr [word ptr [rip + label_44]]
	nop	word ptr cs:[rax + rax]
.label_107:
...
.label_32:
	...
	inc	qword ptr [word ptr [rip + label_36]]
	cmp	qword ptr [word ptr [rip + label_37]],  r13
	jl	.label_38
	jg	.label_48
	mov	rcx,  qword ptr [word ptr [rip + label_47]]
	cmp	ecx, ebx
	jns	.label_48
	nop	dword ptr [rax]
.label_38:
	mov	qword ptr [word ptr [rip + label_37]],  r13
	mov	qword ptr [word ptr [rip + label_47]],  rbx
.label_48:
	cmp	r14d, 6
...
.label_504:
	...
	call	__fprintf_chk
	movq	xmm1, r14
	movdqa	xmm2,  xmmword ptr [word ptr [rip + label_507]]
	punpckldq	xmm1, xmm2
	movapd	xmm3,  xmmword ptr [word ptr [rip + label_508]]
	subpd	xmm1, xmm3
	pshufd	xmm0, xmm1, 0x4e
	addpd	xmm0, xmm1
	mulsd	xmm0,  qword ptr [word ptr [rip + label_509]]
	movq	xmm1, r12
	punpckldq	xmm1, xmm2
	subpd	xmm1, xmm3
...
.label_610:
	...
	mov	eax, OFFSET FLAT:default_tuning
	movss	xmm2,  dword ptr [dword ptr [rip + label_632]]
	jmp	.label_616
.label_639:
	mov	eax, OFFSET FLAT:default_tuning
.label_616:
...
.label_685:
	...
	fadd	dword ptr [dword ptr [+ (rax * 4) + label_686]]
	...
	fadd	dword ptr [dword ptr [+ (rdx * 4) + label_686]]
	fucomip	st(1)
	fstp	st(0)
	setp	dl
	mov	rsi, rbx
...
.label_818:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r15 * 8) + label_877]]
.label_3534:
	test	rdi, rdi
	jne	.label_796
	jmp	.label_884
...
.label_897:
	...
	mov	qword ptr [word ptr [rip + label_901]], OFFSET FLAT:slot0
.label_900:
...
.label_994:
	...
	cmp	eax, 0xe
	ja	.label_1013
	jmp	qword ptr [word ptr [+ (rax * 8) + label_1014]]
.label_3371:
...
.label_1009:
	...
	xor	ebx, ebx
	mov	r13, rbp
	jmp	qword ptr [word ptr [+ (rax * 8) + label_1030]]
.label_3550:
...
.label_1045:
	...
	cmp	eax, 0xe
	ja	.label_1051
	jmp	qword ptr [word ptr [+ (rax * 8) + label_1053]]
.label_3353:
	mov	rax, rbp
	shr	rax, 0x36
	setne	dl
...
.label_1050:
	...
	ja	.label_1061
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (rdx * 8) + label_1058]]
.label_3441:
	mov	rax, rbp
	shr	rax, 0x37
	setne	dl
...
.label_1290:
	...
	mov	rbp, qword ptr [rsp + 0x88]
	ja	.label_1283
	mov	eax,  dword ptr [dword ptr [+ (rcx * 4) + label_1321]]
.label_1283:
...
.label_1641:
	...
	cmp	eax, 4
	ja	.label_1769
	jmp	qword ptr [word ptr [+ (rax * 8) + label_1771]]
.label_3523:
	cmp	rbp, rbx
	mov	rax, rbp
	mov	rcx, qword ptr [rsp + 0xe0]
...
.label_1921:
	...
	movdqa	xmm9,  xmmword ptr [word ptr [rip + label_1888]]
	pxor	xmm3, xmm9
	pshufd	xmm6,  xmmword ptr [word ptr [rip + label_1889]],  0xe8
.label_1913:
	lea	rbx, [rsi + 1]
	movq	xmm4, rbx
...
parse_expression:
	...
	jmp	qword ptr [word ptr [+ (rdx * 8) + label_2112]]
.label_3299:
	mov	rax, qword ptr [rsp + 0x38]
...
.label_3296:
	...
	mov	ebp, 0
	jne	.label_2192
	movdqa	xmm0,  xmmword ptr [word ptr [rip + label_2201]]
...
.label_2077:
	...
	cmp	r15d, 3
	ja	.label_2168
	jmp	qword ptr [word ptr [+ (rax * 8) + label_2170]]
.label_2057:
...
link_nfa_nodes:
	...
	ja	.label_2391
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (rbx * 8) + label_2402]]
.label_3394:
