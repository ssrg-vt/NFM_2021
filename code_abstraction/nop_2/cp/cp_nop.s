...
.label_853:
	...
	mov	eax, OFFSET FLAT:default_tuning
	lea	rdi, [rdi]
	movss	xmm2,  dword ptr [dword ptr [rip + label_854]]
	jmp	.label_855
.label_848:
	mov	rbp, rbp
	mov	eax, OFFSET FLAT:default_tuning
...
.label_846:
	...
	paddq	xmm0,  xmmword ptr [word ptr [rip + label_856]]
...
.label_1001:
	...
	mov	rbp, r13
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_986]]
.label_1435:
	lea	rsi, [rsi]
...
.label_971:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r15 * 8) + label_925]]
.label_1402:
	mov	rsp, rsp
	test	rdi, rdi
	mov	rbp, rbp
