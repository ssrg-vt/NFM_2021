...
.label_158:
	...
	mov	rbp, r13
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_100]]
.label_286:
...
.label_166:
	...
	mov	qword ptr [word ptr [rip + label_170]], OFFSET FLAT:slot0
.label_169:
...
quotearg_char_mem:
	...
	mov	r8, rsi
	mov	rdx, rdi
	mov	rsi,  qword ptr [word ptr [rip + label_182]]
...
quotearg_char:
	...
	mov	ecx, esi
	mov	rax, rdi
	mov	rdx,  qword ptr [word ptr [rip + label_182]]
