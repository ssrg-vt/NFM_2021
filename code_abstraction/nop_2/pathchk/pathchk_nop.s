...
.label_63:
	...
	lea	rsi, [rsi]
	mov	cl, byte ptr [rbp - 0x1a1]
	lea	rsi, [rsi]
	mov	rax, qword ptr [rbp - 0x140]
	mov	byte ptr [rax], cl
	cmp	rdi, qword ptr [rbp - 0xf8]
	jg	.label_41
	mov	rbp, rbp
	movabs	rax, 0x7fffffffffffffff
...
.label_228:
	...
	lea	rsi, [rsi]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_293]]
	nop	
	jmp	rcx
.label_460:
	mov	rbp, rbp
...
.label_320:
	...
	mov	rbp, rbp
	mov	qword ptr [word ptr [label_317]],  rax
.label_319:
...
.label_324:
	...
	mov	rcx,  qword ptr [word ptr [label_317]]
	mov	rbp, rbp
