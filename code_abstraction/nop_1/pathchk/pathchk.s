...
.label_35:
	...
	cmp	r12, 0x100
	jb	.label_31
	mov	ebx, OFFSET FLAT:.str.35
	movzx	eax, byte ptr [rbp]
	cmp	eax, 0x2f
	je	.label_32
	mov	ebx, OFFSET FLAT:.str.36
.label_32:
	call	__errno_location
	mov	r14, rax
	mov	dword ptr [r14], 0
...
.label_62:
	...
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_87]]
.label_291:
	mov	r12d, r11d
...
.label_98:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r13 * 8) + label_85]]
.label_353:
	test	rsi, rsi
	jne	.label_68
	jmp	.label_71
...
quotearg_char_mem:
	...
	mov	r14, rsi
	mov	rbx, rdi
	mov	rcx,  qword ptr [word ptr [rip + label_195]]
...
quotearg_n_custom_mem:
	...
	mov	rbx, rcx
	mov	ebp, edi
	mov	rax,  qword ptr [word ptr [rip + label_195]]
	mov	qword ptr [rsp + 0x30], rax
	movups	xmm0,  xmmword ptr [word ptr [rip + label_196]]
	movaps	xmmword ptr [rsp + 0x20], xmm0
	movups	xmm0,  xmmword ptr [word ptr [rip + label_197]]
