...
.label_793:
	...
	cmp	qword ptr [rbp - 0x1008], 0
	je	.label_787
	lea	rsi, [rsi]
	mov	rdi, qword ptr [rbp - 0x1008]
	mov	rsi, qword ptr [rbp - 0x30]
	call	getfilecon
	mov	dword ptr [rbp - 0x1020], eax
	mov	rsp, rsp
	call	__errno_location
	nop	
	lea	rsi, [rbp - 0x1000]
...
.label_794:
	mov	eax, 0xffffffff
	cmp	eax, dword ptr [rbp - 0x1020]
	je	.label_784
	mov	eax, dword ptr [rbp - 0x1020]
	mov	dword ptr [rbp - 0x101c], eax
	lea	rdi, [rdi]
	jmp	.label_785
.label_784:
	...
	je	.label_790
	cmp	dword ptr [rbp - 0x34], 0xd
	lea	rdi, [rdi]
	je	.label_790
	cmp	dword ptr [rbp - 0x34], 0x26
	mov	rbp, rbp
	je	.label_790
	lea	rdi, [rdi]
	cmp	dword ptr [rbp - 0x34], 0x5f
	lea	rsi, [rsi]
	je	.label_790
	lea	rsi, [rsi]
	mov	eax, dword ptr [rbp - 0x34]
	mov	dword ptr [rbp - 0x1024], eax
	mov	rbp, rbp
	call	__errno_location
	mov	ecx, dword ptr [rbp - 0x1024]
	mov	dword ptr [rax], ecx
	mov	ecx, dword ptr [rbp - 0x1020]
	nop	
	mov	dword ptr [rbp - 0x101c], ecx
	jmp	.label_785
.label_790:
	jmp	.label_787
.label_787:
...
.label_796:
	...
	mov	dword ptr [rax], 9
	mov	rsp, rsp
	mov	dword ptr [rbp - 0x101c], 0xffffffff
	nop	
	jmp	.label_785
.label_795:
	mov	edi, dword ptr [rbp - 4]
	...
	lea	rsi, [rsi]
	mov	ecx, dword ptr [rax]
	mov	dword ptr [rbp - 0x1018], ecx
	call	free_cwd
	mov	rbp, rbp
	mov	ecx, dword ptr [rbp - 0x1018]
...
.label_791:
	...
	nop	
	cmp	dword ptr [rbp - 0x100c], -1
	lea	rsi, [rsi]
	jne	.label_788
	call	__errno_location
	mov	ecx, dword ptr [rax]
	mov	dword ptr [rbp - 0x1010], ecx
	jmp	.label_792
.label_788:
	nop	
	xor	eax, eax
...
lgetfileconat:
	...
	sub	rsp, 0x1020
	lea	rsi, [rsi]
	mov	dword ptr [rbp - 0x1014], edi
	mov	rsp, rsp
	mov	qword ptr [rbp - 0x28], rsi
	mov	qword ptr [rbp - 0x1010], rdx
	cmp	dword ptr [rbp - 0x1014], -0x64
	je	.label_806
	mov	rsp, rsp
	mov	rax, qword ptr [rbp - 0x28]
	mov	rbp, rbp
...
.label_805:
	...
	je	.label_798
	lea	rsi, [rsi]
	cmp	dword ptr [rbp - 0x10], 0xd
	je	.label_798
	cmp	dword ptr [rbp - 0x10], 0x26
	je	.label_798
...
.label_807:
	...
	nop	
	call	lgetfilecon
	mov	dword ptr [rbp - 0x1008], eax
	lea	rsi, [rsi]
	cmp	dword ptr [rbp - 0x1008], -1
	mov	rbp, rbp
	jne	.label_804
	call	__errno_location
	lea	rsi, [rsi]
	mov	ecx, dword ptr [rax]
	mov	dword ptr [rbp - 0x1004], ecx
	mov	rbp, rbp
	jmp	.label_809
.label_804:
	xor	eax, eax
...
.label_828:
	...
	je	.label_830
	lea	rsi, [rsi]
	cmp	dword ptr [rbp - 0x54], 0xd
	je	.label_830
	cmp	dword ptr [rbp - 0x54], 0x26
	mov	rbp, rbp
	je	.label_830
