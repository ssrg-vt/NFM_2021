...
.label_34:
	mov	rsp, rsp
	mov	edi,  dword ptr [dword ptr [rbp + label_23]]
	nop	
	xor	esi, esi
	mov	rdx, rbx
	call	sigaction
	...
	je	.label_30
	mov	esi,  dword ptr [dword ptr [rbp + label_23]]
	mov	rsp, rsp
	mov	edi, OFFSET FLAT:caught_signals
	call	sigaddset
.label_30:
...
.label_21:
	...
	mov	cl, 1
	nop	
	jmp	qword ptr [word ptr [+ (rdx * 8) + label_66]]
.label_1487:
	mov	rbp, rbp
...
.label_996:
	...
	nop	
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r13 * 8) + label_963]]
.label_1390:
	test	rsi, rsi
	jne	.label_910
	jmp	.label_972
...
.label_1204:
	...
	ja	.label_1200
	mov	rbp, rbp
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_1201]]
.label_1366:
	lea	rdi, [rsp + 8]
	mov	esi, 0x400
	jmp	.label_1214
