...
.label_21:
	...
	call	digest_word_file
	mov	rbp, rbp
	cmp	qword ptr [word ptr [rip + label_37]],  0
	jne	.label_25
	mov	rsp, rsp
...
.label_199:
	...
	nop	
	mov	qword ptr [word ptr [rip + label_221]],  rbx
	cmp	rbx, r15
	jbe	.label_222
	mov	rbp, rbp
	call	__ctype_b_loc
...
.label_220:
	...
	mov	rsp, rsp
	mov	rbx,  qword ptr [word ptr [rip + before]]
	cmp	rbx,  qword ptr [word ptr [rip + label_221]]
	jae	.label_201
	mov	rbp,  qword ptr [word ptr [rip + label_221]]
	nop	word ptr cs:[rax + rax]
.label_232:
	lea	rsi, [rsi]
	movsx	edi, byte ptr [rbx]
...
.label_224:
	...
	sub	r14,  qword ptr [word ptr [rip + label_221]]
...
.label_250:
	...
	add	rax, r14
	nop	
	mov	qword ptr [word ptr [rip + label_218]],  rax
	jmp	.label_219
.label_196:
	mov	rsp, rsp
	movzx	eax,  byte ptr [byte ptr [rip + input_reference]]
	...
	lea	rsi, [rsi]
	mov	qword ptr [word ptr [rip + label_218]],  rbx
	cmp	rbx, r12
	jae	.label_219
	call	__ctype_b_loc
	lea	rsi, [rsi]
...
.label_271:
	...
	mov	r9,  qword ptr [word ptr [rip + label_221]]
	mov	rbp, rbp
...
.label_471:
	...
	nop	
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r13 * 8) + label_466]]
.label_2173:
	test	rsi, rsi
	jne	.label_475
	jmp	.label_396
...
.label_950:
	...
	ja	.label_947
	nop	
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_966]]
.label_2359:
	mov	rcx, r12
	test	ch, 0x40
	lea	rdi, [rdi]
...
link_nfa_nodes:
	...
	ja	.label_1270
	lea	rsi, [rsi]
	jmp	qword ptr [word ptr [+ (rdx * 8) + label_1268]]
.label_2266:
	mov	rbp, rbp
	lea	rax, [rcx + rcx*2]
	shl	rax, 3
