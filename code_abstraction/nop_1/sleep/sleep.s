...
.label_17:
	...
	ucomisd	xmm0,  qword ptr [word ptr [label_18]]
	jb	.label_11
...
apply_suffix:
	...
	cmp	esi, 0x6d
	jne	.label_25
	movsd	xmm0,  qword ptr [word ptr [rip + label_27]]
	jmp	.label_24
.label_22:
	test	esi, esi
	je	.label_24
...
.label_54:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r13 * 8) + label_68]]
.label_368:
	test	rsi, rsi
	jne	.label_72
	jmp	.label_75
...
dtotimespec:
	...
	jbe	.label_272
	movsd	xmm1,  qword ptr [word ptr [rip + label_274]]
	ucomisd	xmm1, xmm0
	jbe	.label_275
	cvttsd2si	rdi, xmm0
	xorps	xmm1, xmm1
