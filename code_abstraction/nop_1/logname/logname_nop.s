...
.label_60:
	...
	nop	
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r13 * 8) + label_150]]
.label_329:
	test	rsi, rsi
	jne	.label_34
	jmp	.label_38
...
quotearg_char_mem:
	...
	mov	r14, rsi
	mov	rbx, rdi
	mov	rcx,  qword ptr [word ptr [rip + label_165]]
...
quotearg_n_custom_mem:
	...
	mov	rbx, rcx
	mov	ebp, edi
	mov	rax,  qword ptr [word ptr [rip + label_165]]
	mov	qword ptr [rsp + 0x30], rax
	movups	xmm0,  xmmword ptr [word ptr [rip + label_166]]
	movaps	xmmword ptr [rsp + 0x20], xmm0
	movups	xmm0,  xmmword ptr [word ptr [rip + label_167]]
...
.label_204:
	...
	ja	.label_200
	lea	rsi, [rsi]
	jmp	qword ptr [word ptr [+ (r12 * 8) + label_199]]
.label_283:
	lea	rdi, [rdi]
	xor	edi, edi
	mov	rsp, rsp
