...
.label_40:
	...
	ucomisd	xmm1,  qword ptr [word ptr [rip + label_41]]
	jae	.label_42
	cvttsd2si	rax, xmm1
	mov	ecx, eax
	cvtsi2sd	xmm0, rcx
...
.label_48:
	...
	cmp	esi, 0x64
	jne	.label_51
	movsd	xmm0,  qword ptr [word ptr [rip + label_49]]
	jmp	.label_50
.label_54:
...
dtotimespec:
	...
	jbe	.label_82
	movsd	xmm1,  qword ptr [word ptr [rip + label_84]]
	ucomisd	xmm1, xmm0
	jbe	.label_85
	cvttsd2si	rdi, xmm0
	xorps	xmm1, xmm1
...
.label_195:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r13 * 8) + label_151]]
.label_408:
	test	rsi, rsi
	jne	.label_122
	jmp	.label_96
