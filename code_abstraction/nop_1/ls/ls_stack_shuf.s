...
.label_1621:
	...
	mov	eax, edx
	nop	
	fld	dword ptr [dword ptr [+ (rax * 4) + label_1640]]
	mov	rsp, rsp
...
.label_1624:
	...
	fld	xword ptr [rbp - 0x190]
	mov	rsp, rsp
	fld	dword ptr [dword ptr [rip + label_1654]]
	mov	rbp, rbp
	fmul	st(1), st(0)
	mov	rsp, rsp
	mov	rsi, rsp
...
.label_1659:
	...
	mov	edx, ecx
	nop	
	fld	dword ptr [dword ptr [+ (rdx * 4) + label_1640]]
	mov	rsp, rsp
	fild	qword ptr [rbp - 0x50]
	faddp	st(1)
	mov	rsp, rsp
...
.label_2167:
	...
	mov	rax, qword ptr [rbp - 0x98]
	mov	rsp, rsp
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_2232]]
	lea	rsi, [rsi]
	jmp	rcx
.label_2827:
	jmp	.label_2205
...
.label_2391:
	...
	mov	rax, qword ptr [rbp - 0x88]
	lea	rdi, [rdi]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_2452]]
	jmp	rcx
.label_2837:
...
.label_2295:
	...
	mov	rax, qword ptr [rbp - 0x70]
	lea	rsi, [rsi]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_2404]]
	nop	
	jmp	rcx
.label_2840:
	mov	rbp, rbp
