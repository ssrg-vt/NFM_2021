...
.label_18:
	...
	ja	.label_28
	lea	rsi, [rsi]
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_21]]
.label_310:
	lea	rdi, [rdi]
...
.label_16:
	...
	ja	.label_12
	lea	rsi, [rsi]
	jmp	qword ptr [word ptr [+ (rbx * 8) + label_14]]
.label_334:
...
.label_74:
	...
	nop	
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r13 * 8) + label_167]]
.label_347:
	test	rsi, rsi
	jne	.label_73
	jmp	.label_101
...
.label_239:
	...
	ja	.label_242
	lea	rsi, [rsi]
	jmp	qword ptr [word ptr [+ (r12 * 8) + label_244]]
.label_317:
	lea	rdi, [rdi]
	xor	edi, edi
	mov	rsp, rsp
