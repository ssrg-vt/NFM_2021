...
.label_367:
	...
	sub	edx, ebp
	lea	rsi, [rsi]
	jmp	qword ptr [word ptr [+ (r10 * 8) + label_402]]
.label_2635:
	imul	eax, eax, 0x64
	add	eax, ecx
	mov	rsp, rsp
...
.label_889:
	...
	ja	.label_900
	mov	rbp, rbp
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_894]]
.label_2712:
	lea	rdi, [rsp + 8]
	mov	esi, 0x400
	jmp	.label_885
...
.label_1598:
	...
	ja	.label_1613
	lea	rdi, [rdi]
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_1615]]
.label_2797:
	nop	
...
.label_1678:
	...
	cmp	eax, 8
	ja	.label_1677
	jmp	qword ptr [word ptr [+ (rax * 8) + label_1681]]
.label_2876:
	mov	rbp, rbp
	mov	rdi, r15
	mov	rsi, rbx
