...
.label_858:
	...
	cmp	ecx, 0xe
	ja	.label_867
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_868]]
.label_2709:
	lea	rdi, [rsp + 8]
	mov	esi, 0x400
	jmp	.label_871
.label_866:
	...
	ja	.label_875
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_862]]
.label_2655:
	lea	rdi, [rsp + 8]
	mov	esi, 0x200
	jmp	.label_871
...
.label_899:
	...
	ja	.label_907
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_891]]
.label_2638:
	lea	rdi, [rsp + 8]
	mov	esi, 0x200
	jmp	.label_887
...
.label_1504:
	...
	cmp	eax, 0xa
	ja	.label_1517
	jmp	qword ptr [word ptr [+ (rax * 8) + label_1518]]
.label_2682:
	mov	rdx, qword ptr [rsp]
	test	dl, 8
	jne	.label_1519
...
set_regs:
	...
	mov	rax,  qword ptr [word ptr [rip + label_2070]]
	mov	qword ptr [rbp - 0x60], rax
	movups	xmm0,  xmmword ptr [word ptr [rip + label_2071]]
