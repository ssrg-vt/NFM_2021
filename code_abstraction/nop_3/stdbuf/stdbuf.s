...
.label_52:
	lea	rbp, [rcx + rcx*2]
	mov	dword ptr [dword ptr [+ (rbp * 8) + label_43]],  eax
...
.label_46:
	...
	je	.label_65
	mov	bl, byte ptr [rax]
	mov	r8d,  dword ptr [dword ptr [rip + label_43]]
	lea	eax, [r8 + 0x80]
	cmp	eax, 0x17f
	ja	.label_44
	movsxd	rbp, r8d
...
.label_59:
	...
	je	.label_20
	mov	bl, byte ptr [rcx]
	mov	r8d,  dword ptr [dword ptr [rip + label_25]]
	lea	eax, [r8 + 0x80]
	cmp	eax, 0x17f
	ja	.label_26
	movsxd	rbp, r8d
...
.label_26:
	...
	jmp	.label_39
.label_12:
	mov	r9,  qword ptr [word ptr [rip + label_40]]
	lea	rdi, [rsp + 8]
	mov	esi, 1
	mov	edx, OFFSET FLAT:.str.50
	mov	ecx, OFFSET FLAT:.str.49
...
.label_39:
	...
	mov	al, 1
.label_20:
	mov	rcx,  qword ptr [word ptr [rip + label_50]]
	test	rcx, rcx
	je	.label_51
	mov	bl, byte ptr [rcx]
