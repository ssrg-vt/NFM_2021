...
.label_61:
	...
	lea	r14, [r13 + rax*8]
	nop	
	movsd	xmm0,  qword ptr [word ptr [rip + label_135]]
...
.label_956:
	...
	lea	rsi, [rsi]
	movsd	qword ptr [rsp + 0x40], xmm0
	ucomisd	xmm0,  qword ptr [word ptr [label_215]]
	nop	
	jb	.label_163
	mov	eax, r12d
	jmp	.label_136
...
.label_63:
	...
	subsd	xmm1, xmm0
	mov	rsp, rsp
	mulsd	xmm1,  qword ptr [word ptr [rip + label_91]]
	mov	rsp, rsp
	cvttsd2si	rcx, xmm1
...
.label_900:
	...
	mov	rsp, rsp
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (rdx * 8) + label_892]]
.label_1005:
	mov	rax, rbp
	shr	rax, 0x37
	lea	rsi, [rsi]
...
dtotimespec:
	...
	mov	edx, 0x3b9ac9ff
	lea	rsi, [rsi]
	movsd	xmm1,  qword ptr [word ptr [rip + label_937]]
	lea	rsi, [rsi]
	ucomisd	xmm1, xmm0
	mov	rsp, rsp
	jbe	.label_938
	...
	cvtsi2sd	xmm1, rsi
	subsd	xmm0, xmm1
	mulsd	xmm0,  qword ptr [word ptr [rip + label_936]]
	mov	rbp, rbp
	cvttsd2si	rax, xmm0
	xorps	xmm1, xmm1
	cvtsi2sd	xmm1, rax
