...
.label_38:
	lea	rdi, [rdi]
	mov	byte ptr [byte ptr [no_newline]],  1
	jmp	.label_19
.label_46:
...
.label_34:
	...
	jle	.label_45
	nop	
	test	byte ptr [byte ptr [no_newline]],  1
	je	.label_20
...
.label_20:
	lea	rdi, [rdi]
	mov	byte ptr [byte ptr [no_newline]],  0
.label_45:
	jmp	.label_31
.label_31:
	mov	eax,  dword ptr [dword ptr [optind]]
...
hash_print_statistics:
	...
	movq	xmm0, rdx
	nop	
	movaps	xmm1,  xmmword ptr [word ptr [rip + label_166]]
	punpckldq	xmm0, xmm1
	mov	rbp, rbp
	...
	addpd	xmm3, xmm0
	movsd	xmm0,  qword ptr [word ptr [rip + label_168]]
	mulsd	xmm3, xmm0
...
hash_reset_tuning:
	...
	mov	qword ptr [rdi + 8], rax
	lea	rsi, [rsi]
	mov	ecx,  dword ptr [dword ptr [label_209]]
	lea	rsi, [rsi]
...
check_tuning:
	...
	jmp	.label_222
.label_219:
	movss	xmm0,  dword ptr [dword ptr [label_223]]
	...
	jbe	.label_221
	mov	rsp, rsp
	movss	xmm0,  dword ptr [dword ptr [label_220]]
	mov	rax, qword ptr [rbp - 0x18]
	movss	xmm1, dword ptr [rax + 8]
	mov	rsp, rsp
...
compute_bucket_size:
	...
	jne	.label_224
	lea	rsi, [rsi]
	movss	xmm0,  dword ptr [dword ptr [label_225]]
	mov	rax, qword ptr [rbp - 8]
	mov	rsp, rsp
	mov	rcx, rax
	shr	rcx, 1
...
.label_230:
	...
	movss	xmm0, dword ptr [rbp - 0x14]
	nop	
	movss	xmm1,  dword ptr [dword ptr [rip + label_229]]
	nop	
	movaps	xmm2, xmm0
	subss	xmm2, xmm1
	lea	rdi, [rdi]
...
.label_278:
	...
	lea	rdi, [rdi]
	movss	xmm1,  dword ptr [dword ptr [label_225]]
	mov	rsp, rsp
...
.label_567:
	...
	mov	rbp, rbp
	mov	qword ptr [word ptr [label_564]],  rax
.label_566:
...
.label_576:
	...
	mov	rcx,  qword ptr [word ptr [label_564]]
	mov	rbp, rbp
	mov	qword ptr [rax + 8], rcx
.label_574:
	xor	esi, esi
