...
tee_files:
	...
	mov	dword ptr [rbp - 0x2068], edi
	lea	rsi, [rsi]
	mov	qword ptr [rbp - 0x10], rsi
	nop	
	mov	qword ptr [rbp - 0x2060], 0
	mov	rsp, rsp
	...
	add	rcx, 1
	lea	rdi, [rdi]
	mov	qword ptr [rbp - 0x2060], rcx
	lea	rdi, [rdi]
	mov	dword ptr [rbp - 0x206c], 1
	mov	dword ptr [rbp - 0x2044], eax
.label_40:
	mov	rsp, rsp
	mov	eax, dword ptr [rbp - 0x206c]
	cmp	eax, dword ptr [rbp - 0x2068]
	mov	rsp, rsp
	jg	.label_49
	movsxd	rax, dword ptr [rbp - 0x206c]
	mov	rsp, rsp
	...
	call	fopen_safer
	mov	rsp, rsp
	movsxd	rcx, dword ptr [rbp - 0x206c]
...
.label_41:
	...
	mov	edx, 2
	lea	rsi, [rsi]
	movsxd	rsi, dword ptr [rbp - 0x206c]
...
.label_55:
	...
	call	__errno_location
	mov	ecx, dword ptr [rax]
	mov	dword ptr [rbp - 0x204c], ecx
	mov	rsp, rsp
	call	__errno_location
	lea	rdi, [rdi]
	mov	dl, 1
	cmp	dword ptr [rax], 0x20
	mov	byte ptr [rbp - 0x2045], dl
	jne	.label_56
	mov	rsp, rsp
	mov	al, 1
	cmp	dword ptr [dword ptr [output_error]],  3
...
.label_58:
	mov	rsp, rsp
	test	byte ptr [rbp - 0x202d], 1
	je	.label_53
	lea	rdi, [rdi]
	mov	al, 1
	lea	rsi, [rsi]
	cmp	dword ptr [dword ptr [output_error]],  3
	mov	byte ptr [rbp - 0x204d], al
	mov	rbp, rbp
	je	.label_44
	cmp	dword ptr [dword ptr [output_error]],  4
	nop	
...
.label_44:
	...
	mov	rbp, rbp
	movzx	ecx, al
	mov	edx, dword ptr [rbp - 0x204c]
	movsxd	r8, dword ptr [rbp - 0x206c]
	mov	r9, qword ptr [rbp - 0x10]
	lea	rsi, [rsi]
	mov	r8, qword ptr [r9 + r8*8]
	lea	rsi, [rsi]
	mov	dword ptr [rbp - 0x2054], edx
	mov	rdx, r8
	lea	rdi, [rdi]
	mov	dword ptr [rbp - 0x2028], ecx
	call	quotearg_n_style_colon
	movabs	rdx, OFFSET FLAT:.str_1
	mov	rbp, rbp
	mov	edi, dword ptr [rbp - 0x2028]
	mov	esi, dword ptr [rbp - 0x2054]
	mov	rcx, rax
	nop	
	mov	al, 0
	call	error
...
.label_136:
	...
	lea	rsi, [rsi]
	mov	rcx,  qword ptr [word ptr [+ (rax * 8) + label_232]]
	nop	
	jmp	rcx
.label_505:
	mov	rbp, rbp
