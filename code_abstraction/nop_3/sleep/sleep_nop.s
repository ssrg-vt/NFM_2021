...
.label_21:
	...
	ucomisd	xmm0,  qword ptr [word ptr [label_15]]
	jb	.label_9
	mov	rsp, rsp
...
.label_11:
	...
	nop	
	cmp	eax, 0x73
	movsd	xmm1,  qword ptr [word ptr [rip + label_17]]
	lea	rsi, [rsi]
	je	.label_14
	cmp	eax, 0x6d
	lea	rsi, [rsi]
...
.label_19:
	...
	cmp	eax, 0x64
	jne	.label_9
	movsd	xmm1,  qword ptr [word ptr [rip + label_24]]
	jmp	.label_14
	nop	
.label_9:
	nop	
...
.label_100:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r12 * 8) + label_53]]
.label_357:
	test	r15, r15
	jne	.label_59
	jmp	.label_61
...
quotearg_char_mem:
	...
	mov	rbp, rbp
	mov	rdx, rdi
	mov	rsi,  qword ptr [word ptr [rip + label_191]]
	lea	rdi, [rdi]
...
quotearg_char:
	...
	mov	rax, rdi
	mov	rbp, rbp
	mov	rdx,  qword ptr [word ptr [rip + label_191]]
...
dtotimespec:
	...
	xor	edx, edx
	nop	
	ucomisd	xmm0,  qword ptr [word ptr [rip + label_273]]
	mov	rbp, rbp
	jbe	.label_274
	mov	edx, 0x3b9ac9ff
	lea	rsi, [rsi]
	movsd	xmm1,  qword ptr [word ptr [rip + label_276]]
	lea	rsi, [rsi]
	ucomisd	xmm1, xmm0
	mov	rsp, rsp
	jbe	.label_277
	...
	cvtsi2sd	xmm1, rsi
	subsd	xmm0, xmm1
	mulsd	xmm0,  qword ptr [word ptr [rip + label_275]]
	mov	rbp, rbp
	cvttsd2si	rax, xmm0
	xorps	xmm1, xmm1
	cvtsi2sd	xmm1, rax
