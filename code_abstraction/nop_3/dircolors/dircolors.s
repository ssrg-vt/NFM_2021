...
.label_35:
	...
	mov	r14,  qword ptr [word ptr [rip + label_23]]
	mov	r15, rax
	sub	r15, r14
	jne	.label_30
...
.label_30:
	...
	mov	rdx, rcx
	sub	rdx, rax
	mov	rsi,  qword ptr [word ptr [rip + label_21]]
	mov	rdi, rsi
	sub	rdi, rax
	cmp	rdx, rdi
	cmova	rcx, rsi
	mov	qword ptr [word ptr [rip + label_22]],  rcx
...
.label_49:
	...
	jne	.label_44
	mov	rax,  qword ptr [word ptr [rip + label_22]]
	cmp	qword ptr [word ptr [rip + label_21]],  rax
	jne	.label_47
	mov	edi, OFFSET FLAT:lsc_obstack
	mov	esi, 1
...
.label_71:
	...
	mov	cl, byte ptr [r14]
	lea	rdx, [rax + 1]
	mov	qword ptr [word ptr [rip + label_22]],  rdx
	mov	byte ptr [rax], cl
	mov	rax,  qword ptr [word ptr [rip + label_22]]
	cmp	qword ptr [word ptr [rip + label_21]],  rax
	jne	.label_77
