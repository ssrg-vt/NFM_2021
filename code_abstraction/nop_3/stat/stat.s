...
.label_57:
	...
	jmp	.label_49
.label_50:
	jmp	qword ptr [word ptr [+ (rax * 8) + label_69]]
.label_1181:
	mov	bl, 7
	jmp	.label_51
.label_67:
...
print_stat:
	...
	cmp	edx, 0x39
	ja	.label_282
	jmp	qword ptr [word ptr [+ (rdx * 8) + label_288]]
.label_1026:
	mov	esi, OFFSET FLAT:human_access.modebuf
	mov	rdi, rbx
	call	filemodestring
	mov	byte ptr [byte ptr [rip + label_291]],  0
...
.label_524:
	...
	xor	eax, eax
	xor	edi, edi
	jmp	qword ptr [word ptr [+ (rdx * 8) + label_532]]
.label_1094:
	mov	r10d, r9d
	cmp	r10d, 0x45
	je	.label_449
...
.label_577:
	...
	sub	ebx, eax
	sub	r8d, edi
	jmp	qword ptr [word ptr [+ (r9 * 8) + label_590]]
.label_1146:
	imul	edx, edx, 0x64
	add	edx, ebx
	mov	edi, 5
...
.label_625:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r15 * 8) + label_676]]
.label_1141:
	test	rdi, rdi
	jne	.label_660
	jmp	.label_683
