...
.label_505:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r13 * 8) + label_480]]
.label_2261:
	test	rsi, rsi
	jne	.label_430
	jmp	.label_452
...
.label_514:
	...
	mov	qword ptr [word ptr [rip + label_518]], OFFSET FLAT:slot0
.label_517:
...
.label_624:
	...
	cmp	ecx, 0xe
	ja	.label_632
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_633]]
.label_2291:
	lea	rdi, [rsp + 8]
	mov	esi, 0x400
	jmp	.label_628
...
.label_775:
	...
	ja	.label_748
	mov	rax, qword ptr [rsp + 0x50]
	jmp	qword ptr [word ptr [+ (rax * 8) + label_779]]
.label_2266:
	mov	rcx, qword ptr [rsp + 0x180]
	cmp	rcx, r13
	jl	.label_723
...
.label_1003:
	...
	jmp	qword ptr [word ptr [+ (rax * 8) + label_1008]]
.label_2316:
	test	r14, r14
	jne	.label_1016
.label_2313:
...
set_regs:
	...
	mov	r15, qword ptr [rdi]
	mov	rax,  qword ptr [word ptr [rip + label_1525]]
	mov	qword ptr [rbp - 0x60], rax
	movups	xmm0,  xmmword ptr [word ptr [rip + label_1526]]
