...
.label_28:
	...
	cmp	eax, 8
	ja	.label_36
	jmp	qword ptr [word ptr [+ (rax * 8) + label_57]]
.label_2782:
...
.label_46:
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_76]]
.label_2925:
...
.label_10:
	...
	call	digest_word_file
	cmp	qword ptr [word ptr [rip + label_184]],  0
	jne	.label_180
...
.label_27:
	...
	mov	rax, qword ptr [rax]
	xor	ecx, ecx
	movdqa	xmm0,  xmmword ptr [word ptr [rip + label_42]]
	pand	xmm0,  xmmword ptr [word ptr [rip + label_43]]
	nop	word ptr cs:[rax + rax]
.label_62:
	...
	pand	xmm1, xmm0
	packuswb	xmm1, xmm1
	movq	qword ptr [word ptr [rcx + label_61]],  xmm1
	add	rcx, 0x20
	cmp	rcx, 0x100
	jne	.label_62
	mov	byte ptr [byte ptr [rip + label_172]],  1
	...
	mov	byte ptr [byte ptr [rip + label_122]],  1
	mov	dword ptr [dword ptr [rip + label_123]],  0x1010101
	movdqu	xmm2,  xmmword ptr [word ptr [rip + label_124]]
	pxor	xmm0, xmm0
	pcmpeqb	xmm2, xmm0
	movdqa	xmm1,  xmmword ptr [word ptr [rip + label_125]]
	pandn	xmm2, xmm1
	movdqa	xmmword ptr [word ptr [rip + label_126]],  xmm2
	movdqu	xmm2,  xmmword ptr [word ptr [rip + label_127]]
	pcmpeqb	xmm2, xmm0
	pandn	xmm2, xmm1
	movdqa	xmmword ptr [word ptr [rip + label_128]],  xmm2
	movdqu	xmm2,  xmmword ptr [word ptr [rip + label_129]]
	pcmpeqb	xmm2, xmm0
	pandn	xmm2, xmm1
	movdqa	xmmword ptr [word ptr [rip + label_130]],  xmm2
	movdqu	xmm2,  xmmword ptr [word ptr [rip + label_131]]
	pcmpeqb	xmm2, xmm0
	pandn	xmm2, xmm1
	movdqa	xmmword ptr [word ptr [rip + label_132]],  xmm2
	movdqu	xmm2,  xmmword ptr [word ptr [rip + label_133]]
	pcmpeqb	xmm2, xmm0
	pandn	xmm2, xmm1
	movdqa	xmmword ptr [word ptr [rip + label_134]],  xmm2
	movdqu	xmm2,  xmmword ptr [word ptr [rip + label_135]]
	pcmpeqb	xmm2, xmm0
	pandn	xmm2, xmm1
	movdqa	xmmword ptr [word ptr [rip + label_136]],  xmm2
	movdqu	xmm2,  xmmword ptr [word ptr [rip + label_137]]
	pcmpeqb	xmm2, xmm0
	pandn	xmm2, xmm1
	movdqa	xmmword ptr [word ptr [rip + label_138]],  xmm2
	movdqu	xmm2,  xmmword ptr [word ptr [rip + label_139]]
	pcmpeqb	xmm2, xmm0
	pandn	xmm2, xmm1
	movdqa	xmmword ptr [word ptr [rip + label_140]],  xmm2
	jmp	.label_113
.label_173:
	mov	byte ptr [byte ptr [rip + label_214]],  1
.label_113:
	pxor	xmm0, xmm0
...
.label_89:
	...
	mov	qword ptr [word ptr [rip + label_48]],  rax
	cmp	rax, rbx
	jbe	.label_98
	mov	rcx, qword ptr [rsp + 0x48]
...
.label_156:
	...
	je	.label_221
	mov	qword ptr [word ptr [rip + label_48]],  rcx
	lea	rdx, [rcx - 1]
	cmp	rcx, rbx
	mov	rax, rcx
	ja	.label_156
...
.label_177:
	...
	mov	r14,  qword ptr [word ptr [rip + before_max_width]]
	mov	rax,  qword ptr [word ptr [rip + label_48]]
	mov	rdx, rax
	jmp	.label_189
	nop	word ptr cs:[rax + rax]
.label_171:
...
.label_274:
	...
	jb	.label_274
.label_68:
	mov	qword ptr [word ptr [rip + label_66]],  rax
	mov	rbp, rax
	cmp	rax, r15
	jae	.label_281
	nop	dword ptr [rax]
.label_212:
	mov	qword ptr [word ptr [rip + label_66]],  rbp
	cmp	qword ptr [word ptr [rip + word_regex]],  0
	je	.label_191
	mov	rdx, r15
	sub	rdx, rbp
...
.label_277:
	...
	jmp	.label_89
.label_289:
	mov	rbp,  qword ptr [word ptr [rip + label_66]]
	mov	r14, qword ptr [rsp + 0x40]
.label_331:
	cmp	rbp, rax
	jbe	.label_203
...
.label_26:
	...
	mov	qword ptr [word ptr [rip + label_114]],  rdx
	cmp	rdx, r13
	jbe	.label_115
...
.label_179:
	...
	mov	qword ptr [word ptr [rip + head]],  rbx
	mov	rdx,  qword ptr [word ptr [rip + label_114]]
.label_150:
	lea	rax, [rbx + rbp]
	cmp	rax, rdx
	jae	.label_164
...
.label_246:
	...
	mov	rsi,  qword ptr [word ptr [rip + label_66]]
	call	print_field
	mov	rsi,  qword ptr [word ptr [rip + stdout]]
...
.label_117:
	...
	mov	rsi,  qword ptr [word ptr [rip + label_114]]
	call	print_field
	mov	rdi,  qword ptr [word ptr [rip + stdout]]
	mov	rax, qword ptr [rdi + 0x28]
	cmp	rax, qword ptr [rdi + 0x30]
...
.label_334:
	...
	mov	r8,  qword ptr [word ptr [rip + label_48]]
	mov	rsi,  qword ptr [word ptr [rip + before]]
	mov	rax,  qword ptr [word ptr [rip + truncation_string_length]]
	xor	ebp, ebp
	sub	rbp, rax
	...
	xor	ebx, ebx
.label_49:
	mov	rdi,  qword ptr [word ptr [rip + label_66]]
	mov	rax,  qword ptr [word ptr [rip + tail]]
	test	cl, cl
	mov	ecx, 0
	cmove	rbp, rcx
...
.label_220:
	...
	shr	ecx, 0xa
	and	cl, 1
	mov	byte ptr [byte ptr [rbx + label_217]],  cl
	mov	rcx, qword ptr [rax]
...
.label_377:
	...
	cmp	eax, 0xa
	ja	.label_362
	jmp	qword ptr [word ptr [+ (rax * 8) + label_363]]
.label_2947:
...
.label_410:
	...
	jmp	qword ptr [word ptr [+ (rax * 8) + label_427]]
.label_2953:
	movzx	eax, cl
	cmp	eax, 0x69
...
.label_600:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r15 * 8) + label_523]]
.label_2967:
	test	rdi, rdi
	jne	.label_509
	jmp	.label_531
...
.label_1280:
	...
	movdqa	xmm9,  xmmword ptr [word ptr [rip + label_1308]]
	pxor	xmm3, xmm9
	pshufd	xmm6,  xmmword ptr [word ptr [rip + label_1309]],  0xe8
.label_1334:
	lea	rbx, [rsi + 1]
	movq	xmm4, rbx
...
.label_1394:
	...
	cmp	edx, 0xa
	ja	.label_1388
	jmp	qword ptr [word ptr [+ (rdx * 8) + label_1395]]
.label_2911:
	test	r13d, 0x80000
	jne	.label_1372
	and	eax, 0xffffff00
...
parse_expression:
	...
	jmp	qword ptr [word ptr [+ (rdx * 8) + label_1661]]
.label_2864:
	mov	rax, qword ptr [rsp + 0x38]
...
.label_2861:
	...
	mov	ebp, 0
	jne	.label_1500
	movdqa	xmm0,  xmmword ptr [word ptr [rip + label_1508]]
...
set_regs:
	...
	mov	rcx, qword ptr [rdi]
	mov	rax,  qword ptr [word ptr [rip + label_2038]]
	mov	qword ptr [rbp - 0x50], rax
	movups	xmm0,  xmmword ptr [word ptr [rip + label_2039]]
