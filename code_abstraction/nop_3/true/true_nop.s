...
.label_47:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r12 * 8) + label_78]]
.label_289:
	test	r15, r15
	jne	.label_31
	jmp	.label_84
...
.label_148:
	...
	mov	rsp, rsp
	mov	qword ptr [word ptr [rip + label_152]], OFFSET FLAT:slot0
.label_151:
...
quotearg_char_mem:
	...
	mov	rbp, rbp
	mov	rdx, rdi
	mov	rsi,  qword ptr [word ptr [rip + label_164]]
	lea	rdi, [rdi]
	mov	qword ptr [rsp + 0x30], rsi
	movups	xmm0,  xmmword ptr [word ptr [rip + label_165]]
	movaps	xmmword ptr [rsp + 0x20], xmm0
	movups	xmm0,  xmmword ptr [word ptr [rip + label_166]]
	nop	
	movaps	xmmword ptr [rsp + 0x10], xmm0
	lea	rdi, [rdi]
...
quotearg_char:
	...
	mov	rax, rdi
	mov	rbp, rbp
	mov	rdx,  qword ptr [word ptr [rip + label_164]]
...
quotearg_colon:
	...
	mov	rax, rdi
	lea	rdi, [rdi]
	mov	rcx,  qword ptr [word ptr [rip + label_164]]
	nop	
	mov	qword ptr [rsp + 0x30], rcx
	movups	xmm0,  xmmword ptr [word ptr [rip + label_165]]
	movaps	xmmword ptr [rsp + 0x20], xmm0
...
quotearg_n_custom:
	...
	sub	rsp, 0x38
	nop	
	mov	rax,  qword ptr [word ptr [rip + label_164]]
	mov	rsp, rsp
