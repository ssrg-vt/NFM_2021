...
.label_51:
	...
	mov	rsp, rsp
	mov	r10, r15
	jmp	qword ptr [word ptr [+ (rcx * 8) + label_140]]
.label_269:
	mov	r15d, edi
	lea	rsi, [rsi]
...
.label_73:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r12 * 8) + label_138]]
.label_294:
	test	r15, r15
	jne	.label_37
	jmp	.label_145
...
quotearg_char_mem:
	...
	mov	rbp, rbp
	mov	rdx, rdi
	mov	rsi,  qword ptr [word ptr [rip + label_174]]
	lea	rdi, [rdi]
...
quotearg_char:
	...
	mov	rax, rdi
	mov	rbp, rbp
	mov	rdx,  qword ptr [word ptr [rip + label_174]]
