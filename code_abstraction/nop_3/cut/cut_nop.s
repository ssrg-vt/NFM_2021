...
.label_360:
	...
	mov	rsp, rsp
	mov	qword ptr [word ptr [rip + label_364]], OFFSET FLAT:slot0
.label_362:
...
quotearg_char_mem:
	...
	mov	rbp, rbp
	mov	rdx, rdi
	mov	rsi,  qword ptr [word ptr [rip + label_376]]
	lea	rdi, [rdi]
	mov	qword ptr [rsp + 0x30], rsi
	movups	xmm0,  xmmword ptr [word ptr [rip + label_377]]
	movaps	xmmword ptr [rsp + 0x20], xmm0
	movups	xmm0,  xmmword ptr [word ptr [rip + label_378]]
	nop	
	movaps	xmmword ptr [rsp + 0x10], xmm0
	lea	rdi, [rdi]
...
quotearg_char:
	...
	mov	rax, rdi
	mov	rbp, rbp
	mov	rdx,  qword ptr [word ptr [rip + label_376]]
...
quotearg_colon:
	...
	mov	rax, rdi
	lea	rdi, [rdi]
	mov	rcx,  qword ptr [word ptr [rip + label_376]]
	nop	
	mov	qword ptr [rsp + 0x30], rcx
	movups	xmm0,  xmmword ptr [word ptr [rip + label_377]]
	movaps	xmmword ptr [rsp + 0x20], xmm0
...
quotearg_n_custom:
	...
	sub	rsp, 0x38
	nop	
	mov	rax,  qword ptr [word ptr [rip + label_376]]
	mov	rsp, rsp
