...
.label_85:
	...
	mov	bl, 0x61
	xor	eax, eax
	jmp	qword ptr [word ptr [+ (r12 * 8) + label_116]]
.label_328:
	test	r15, r15
	jne	.label_80
	jmp	.label_123
...
.label_186:
	...
	mov	rsp, rsp
	mov	qword ptr [word ptr [rip + label_190]], OFFSET FLAT:slot0
.label_189:
...
quotearg_colon:
	...
	mov	rax, rdi
	lea	rdi, [rdi]
	mov	rcx,  qword ptr [word ptr [rip + label_202]]
	nop	
	mov	qword ptr [rsp + 0x30], rcx
	movups	xmm0,  xmmword ptr [word ptr [rip + label_203]]
	movaps	xmmword ptr [rsp + 0x20], xmm0
...
quotearg_n_custom:
	...
	sub	rsp, 0x38
	nop	
	mov	rax,  qword ptr [word ptr [rip + label_202]]
	mov	rsp, rsp
