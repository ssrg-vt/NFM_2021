...
perrf:
	...
	movaps	xmmword ptr [rbp - 0x10], xmm3
	...
	movaps	xmm2, xmmword ptr [rbp - 0x110]
	movaps	xmmword ptr [rbp - 0xb0], xmm2
	mov	rbp, rbp
	movaps	xmm3, xmmword ptr [rbp - 0x10]
	mov	rbp, rbp
	...
	movaps	xmm7, xmmword ptr [rbp - 0x130]
	nop	
...
.label_22:
	...
	lea	rsi, [rsi]
	mov	dword ptr [rbp - 0x19c], 0x30
	mov	rbp, rbp
	mov	dword ptr [rbp - 0x1a0], 8
...
errf:
	...
	sub	rsp, 0x1a0
	test	al, al
	movaps	xmmword ptr [rbp - 0x1a0], xmm7
	nop	
	movaps	xmmword ptr [rbp - 0x160], xmm6
	mov	rbp, rbp
	movaps	xmmword ptr [rbp - 0x170], xmm5
	movaps	xmmword ptr [rbp - 0x60], xmm4
	lea	rdi, [rdi]
	movaps	xmmword ptr [rbp - 0x190], xmm3
	...
	mov	rbp, rbp
	movaps	xmm3, xmmword ptr [rbp - 0x190]
	movaps	xmmword ptr [rbp - 0xd0], xmm3
	movaps	xmm4, xmmword ptr [rbp - 0x60]
	lea	rdi, [rdi]
	...
	mov	rsp, rsp
	movaps	xmm6, xmmword ptr [rbp - 0x160]
	movaps	xmmword ptr [rbp - 0xa0], xmm6
	movaps	xmm7, xmmword ptr [rbp - 0x1a0]
